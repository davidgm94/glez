...
#include "mmx.h"
#include <x86intrin.h>
typedef int vec4s32 VECTOR_TYPE(4);
typedef int vec4i VECTOR_TYPE(4);
typedef float vec4f32_unaligned VECTOR_TYPE(4);
typedef vec4f32_unaligned vec4f_unaligned;
typedef float vec4f32 VECTOR_TYPE_ALIGNMENT(4, 16);
typedef vec4f32 vec4f;

typedef float vec4f_u VECTOR_TYPE_ALIGNMENT(4, 1);

/* Unsigned types */
typedef unsigned int vec4u32 VECTOR_TYPE(4);
...
sse_add_ss(vec4f __a, vec4f __b)
{
    __a[0] += __b[0];
    return __a;
}
...
///    operands.
static __inline__ vec4f __DEFAULT_FN_ATTRS
sse_add_ps(vec4f __a, vec4f __b)
{
    return (vec4f)((vec4f32_unaligned)__a + (vec4f32_unaligned)__b);
}
...
static __inline__ vec4f __DEFAULT_FN_ATTRS
sse_sub_ss(vec4f __a, vec4f __b)
{
    __a[0] -= __b[0];
    return __a;
}
...
///    both operands.
static __inline__ vec4f __DEFAULT_FN_ATTRS
sse_sub_ps(vec4f __a, vec4f __b)
{
    return (vec4f)((vec4f32_unaligned)__a - (vec4f32_unaligned)__b);
}
...
static __inline__ vec4f __DEFAULT_FN_ATTRS
sse_mul_ss(vec4f __a, vec4f __b)
{
    __a[0] *= __b[0];
    return __a;
}
...
///    operands.
static __inline__ vec4f __DEFAULT_FN_ATTRS
sse_mul_ps(vec4f __a, vec4f __b)
{
    return (vec4f)((vec4f32_unaligned)__a * (vec4f32_unaligned)__b);
}
...
static __inline__ vec4f __DEFAULT_FN_ATTRS
sse_div_ss(vec4f __a, vec4f __b)
{
    __a[0] /= __b[0];
    return __a;
}
...
///    operands.
static __inline__ vec4f __DEFAULT_FN_ATTRS
sse_div_ps(vec4f __a, vec4f __b)
{
    return (vec4f)((vec4f32_unaligned)__a / (vec4f32_unaligned)__b);
}
...
static __inline__ vec4f __DEFAULT_FN_ATTRS
sse_sqrt_ss(vec4f __a)
{
    return (vec4f)__builtin_ia32_sqrtss((vec4f32_unaligned)__a);
}
...
static __inline__ vec4f __DEFAULT_FN_ATTRS
sse_sqrt_ps(vec4f __a)
{
    return __builtin_ia32_sqrtps((vec4f32_unaligned)__a);
}
...
static __inline__ vec4f __DEFAULT_FN_ATTRS
sse_rcp_ss(vec4f __a)
{
    return (vec4f)__builtin_ia32_rcpss((vec4f32_unaligned)__a);
}
...
static __inline__ vec4f __DEFAULT_FN_ATTRS
sse_rcp_ps(vec4f __a)
{
    return (vec4f)__builtin_ia32_rcpps((vec4f32_unaligned)__a);
}
...
///    operand.
static __inline__ vec4f __DEFAULT_FN_ATTRS
sse_rsqrt_ss(vec4f __a)
{
    return __builtin_ia32_rsqrtss((vec4f32_unaligned)__a);
}
...
static __inline__ vec4f __DEFAULT_FN_ATTRS
sse_rsqrt_ps(vec4f __a)
{
    return __builtin_ia32_rsqrtps((vec4f32_unaligned)__a);
}
...
///    the upper 96 bits of the first source operand.
static __inline__ vec4f __DEFAULT_FN_ATTRS
sse_min_ss(vec4f __a, vec4f __b)
{
    return __builtin_ia32_minss((vec4f32_unaligned)__a, (vec4f32_unaligned)__b);
}
...
static __inline__ vec4f __DEFAULT_FN_ATTRS
sse_min_ps(vec4f __a, vec4f __b)
{
    return __builtin_ia32_minps((vec4f32_unaligned)__a, (vec4f32_unaligned)__b);
}
...
///    the upper 96 bits of the first source operand.
static __inline__ vec4f __DEFAULT_FN_ATTRS
sse_max_ss(vec4f __a, vec4f __b)
{
    return __builtin_ia32_maxss((vec4f32_unaligned)__a, (vec4f32_unaligned)__b);
}
...
///    between both operands.
static __inline__ vec4f __DEFAULT_FN_ATTRS
sse_max_ps(vec4f __a, vec4f __b)
{
    return __builtin_ia32_maxps((vec4f32_unaligned)__a, (vec4f32_unaligned)__b);
}
...
static __inline__ vec4f __DEFAULT_FN_ATTRS
sse_and_ps(vec4f __a, vec4f __b)
{
    return (vec4f)((vec4u)__a & (vec4u)__b);
}
...
///    operand.
static __inline__ vec4f __DEFAULT_FN_ATTRS
sse_andnot_ps(vec4f __a, vec4f __b)
{
    return (vec4f)(~(vec4u)__a & (vec4u)__b);
}
...
static __inline__ vec4f __DEFAULT_FN_ATTRS
sse_xor_ps(vec4f __a, vec4f __b)
{
    return (vec4f)((vec4u)__a ^ (vec4u)__b);
}
...
static __inline__ vec4f __DEFAULT_FN_ATTRS
sse_cmpeq_ss(vec4f __a, vec4f __b)
{
    return (vec4f)__builtin_ia32_cmpeqss((vec4f32_unaligned)__a, (vec4f32_unaligned)__b);
}
...
/// \returns A 128-bit vector of [4 x float] containing the comparison results.
static __inline__ vec4f __DEFAULT_FN_ATTRS
sse_cmpeq_ps(vec4f __a, vec4f __b)
{
    return (vec4f)__builtin_ia32_cmpeqps((vec4f32_unaligned)__a, (vec4f32_unaligned)__b);
}
...
///    in the low-order bits.
static __inline__ vec4f __DEFAULT_FN_ATTRS
sse_cmplt_ss(vec4f __a, vec4f __b)
{
    return (vec4f)__builtin_ia32_cmpltss((vec4f32_unaligned)__a, (vec4f32_unaligned)__b);
}
...
/// \returns A 128-bit vector of [4 x float] containing the comparison results.
static __inline__ vec4f __DEFAULT_FN_ATTRS
sse_cmplt_ps(vec4f __a, vec4f __b)
{
    return (vec4f)__builtin_ia32_cmpltps((vec4f32_unaligned)__a, (vec4f32_unaligned)__b);
}
...
///    in the low-order bits.
static __inline__ vec4f __DEFAULT_FN_ATTRS
sse_cmple_ss(vec4f __a, vec4f __b)
{
    return (vec4f)__builtin_ia32_cmpless((vec4f32_unaligned)__a, (vec4f32_unaligned)__b);
}
...
/// \returns A 128-bit vector of [4 x float] containing the comparison results.
static __inline__ vec4f __DEFAULT_FN_ATTRS
sse_cmple_ps(vec4f __a, vec4f __b)
{
    return (vec4f)__builtin_ia32_cmpleps((vec4f32_unaligned)__a, (vec4f32_unaligned)__b);
}
...
///    in the low-order bits.
static __inline__ vec4f __DEFAULT_FN_ATTRS
sse_cmpgt_ss(vec4f __a, vec4f __b)
{
    return (vec4f)__builtin_shufflevector((vec4f32_unaligned)__a,
                                           (vec4f32_unaligned)__builtin_ia32_cmpltss((vec4f32_unaligned)__b, (vec4f32_unaligned)__a),
                                           4, 1, 2, 3);
}
...
/// \returns A 128-bit vector of [4 x float] containing the comparison results.
static __inline__ vec4f __DEFAULT_FN_ATTRS
sse_cmpgt_ps(vec4f __a, vec4f __b)
{
    return (vec4f)__builtin_ia32_cmpltps((vec4f32_unaligned)__b, (vec4f32_unaligned)__a);
}
...
///    in the low-order bits.
static __inline__ vec4f __DEFAULT_FN_ATTRS
sse_cmpge_ss(vec4f __a, vec4f __b)
{
    return (vec4f)__builtin_shufflevector((vec4f32_unaligned)__a,
                                           (vec4f32_unaligned)__builtin_ia32_cmpless((vec4f32_unaligned)__b, (vec4f32_unaligned)__a),
                                           4, 1, 2, 3);
}
...
/// \returns A 128-bit vector of [4 x float] containing the comparison results.
static __inline__ vec4f __DEFAULT_FN_ATTRS
sse_cmpge_ps(vec4f __a, vec4f __b)
{
    return (vec4f)__builtin_ia32_cmpleps((vec4f32_unaligned)__b, (vec4f32_unaligned)__a);
}
...
///    in the low-order bits.
static __inline__ vec4f __DEFAULT_FN_ATTRS
sse_cmpneq_ss(vec4f __a, vec4f __b)
{
    return (vec4f)__builtin_ia32_cmpneqss((vec4f32_unaligned)__a, (vec4f32_unaligned)__b);
}
...
/// \returns A 128-bit vector of [4 x float] containing the comparison results.
static __inline__ vec4f __DEFAULT_FN_ATTRS
sse_cmpneq_ps(vec4f __a, vec4f __b)
{
    return (vec4f)__builtin_ia32_cmpneqps((vec4f32_unaligned)__a, (vec4f32_unaligned)__b);
}
...
///    in the low-order bits.
static __inline__ vec4f __DEFAULT_FN_ATTRS
sse_cmpnlt_ss(vec4f __a, vec4f __b)
{
    return (vec4f)__builtin_ia32_cmpnltss((vec4f32_unaligned)__a, (vec4f32_unaligned)__b);
}
...
/// \returns A 128-bit vector of [4 x float] containing the comparison results.
static __inline__ vec4f __DEFAULT_FN_ATTRS
sse_cmpnlt_ps(vec4f __a, vec4f __b)
{
    return (vec4f)__builtin_ia32_cmpnltps((vec4f32_unaligned)__a, (vec4f32_unaligned)__b);
}
...
///    in the low-order bits.
static __inline__ vec4f __DEFAULT_FN_ATTRS
sse_cmpnle_ss(vec4f __a, vec4f __b)
{
    return (vec4f)__builtin_ia32_cmpnless((vec4f32_unaligned)__a, (vec4f32_unaligned)__b);
}
...
/// \returns A 128-bit vector of [4 x float] containing the comparison results.
static __inline__ vec4f __DEFAULT_FN_ATTRS
sse_cmpnle_ps(vec4f __a, vec4f __b)
{
    return (vec4f)__builtin_ia32_cmpnleps((vec4f32_unaligned)__a, (vec4f32_unaligned)__b);
}
...
///    in the low-order bits.
static __inline__ vec4f __DEFAULT_FN_ATTRS
sse_cmpngt_ss(vec4f __a, vec4f __b)
{
    return (vec4f)__builtin_shufflevector((vec4f32_unaligned)__a,
                                           (vec4f32_unaligned)__builtin_ia32_cmpnltss((vec4f32_unaligned)__b, (vec4f32_unaligned)__a),
                                           4, 1, 2, 3);
}
...
/// \returns A 128-bit vector of [4 x float] containing the comparison results.
static __inline__ vec4f __DEFAULT_FN_ATTRS
sse_cmpngt_ps(vec4f __a, vec4f __b)
{
    return (vec4f)__builtin_ia32_cmpnltps((vec4f32_unaligned)__b, (vec4f32_unaligned)__a);
}
...
///    in the low-order bits.
static __inline__ vec4f __DEFAULT_FN_ATTRS
sse_cmpnge_ss(vec4f __a, vec4f __b)
{
    return (vec4f)__builtin_shufflevector((vec4f32_unaligned)__a,
                                           (vec4f32_unaligned)__builtin_ia32_cmpnless((vec4f32_unaligned)__b, (vec4f32_unaligned)__a),
                                           4, 1, 2, 3);
}
...
/// \returns A 128-bit vector of [4 x float] containing the comparison results.
static __inline__ vec4f __DEFAULT_FN_ATTRS
sse_cmpnge_ps(vec4f __a, vec4f __b)
{
    return (vec4f)__builtin_ia32_cmpnleps((vec4f32_unaligned)__b, (vec4f32_unaligned)__a);
}
...
///    in the low-order bits.
static __inline__ vec4f __DEFAULT_FN_ATTRS
sse_cmpord_ss(vec4f __a, vec4f __b)
{
    return (vec4f)__builtin_ia32_cmpordss((vec4f32_unaligned)__a, (vec4f32_unaligned)__b);
}
...
/// \returns A 128-bit vector of [4 x float] containing the comparison results.
static __inline__ vec4f __DEFAULT_FN_ATTRS
sse_cmpord_ps(vec4f __a, vec4f __b)
{
    return (vec4f)__builtin_ia32_cmpordps((vec4f32_unaligned)__a, (vec4f32_unaligned)__b);
}
...
///    in the low-order bits.
static __inline__ vec4f __DEFAULT_FN_ATTRS
sse_cmpunord_ss(vec4f __a, vec4f __b)
{
    return (vec4f)__builtin_ia32_cmpunordss((vec4f32_unaligned)__a, (vec4f32_unaligned)__b);
}
...
/// \returns A 128-bit vector of [4 x float] containing the comparison results.
static __inline__ vec4f __DEFAULT_FN_ATTRS
sse_cmpunord_ps(vec4f __a, vec4f __b)
{
    return (vec4f)__builtin_ia32_cmpunordps((vec4f32_unaligned)__a, (vec4f32_unaligned)__b);
}
...
sse_comieq_ss(vec4f __a, vec4f __b)
{
    return __builtin_ia32_comieq((vec4f32_unaligned)__a, (vec4f32_unaligned)__b);
}
...
static __inline__ int __DEFAULT_FN_ATTRS
sse_comilt_ss(vec4f __a, vec4f __b)
{
    return __builtin_ia32_comilt((vec4f32_unaligned)__a, (vec4f32_unaligned)__b);
}
...
///     lower 32-bit values is NaN, 0 is returned.
static __inline__ int __DEFAULT_FN_ATTRS
sse_comile_ss(vec4f __a, vec4f __b)
{
    return __builtin_ia32_comile((vec4f32_unaligned)__a, (vec4f32_unaligned)__b);
}
...
///     two lower 32-bit values is NaN, 0 is returned.
static __inline__ int __DEFAULT_FN_ATTRS
sse_comigt_ss(vec4f __a, vec4f __b)
{
    return __builtin_ia32_comigt((vec4f32_unaligned)__a, (vec4f32_unaligned)__b);
}
...
///    lower 32-bit values is NaN, 0 is returned.
static __inline__ int __DEFAULT_FN_ATTRS
sse_comige_ss(vec4f __a, vec4f __b)
{
    return __builtin_ia32_comige((vec4f32_unaligned)__a, (vec4f32_unaligned)__b);
}
...
static __inline__ int __DEFAULT_FN_ATTRS
sse_comineq_ss(vec4f __a, vec4f __b)
{
    return __builtin_ia32_comineq((vec4f32_unaligned)__a, (vec4f32_unaligned)__b);
}
...
///     lower 32-bit values is NaN, 0 is returned.
static __inline__ int __DEFAULT_FN_ATTRS
sse_ucomieq_ss(vec4f __a, vec4f __b)
{
    return __builtin_ia32_ucomieq((vec4f32_unaligned)__a, (vec4f32_unaligned)__b);
}
...
///    lower 32-bit values is NaN, 0 is returned.
static __inline__ int __DEFAULT_FN_ATTRS
sse_ucomilt_ss(vec4f __a, vec4f __b)
{
    return __builtin_ia32_ucomilt((vec4f32_unaligned)__a, (vec4f32_unaligned)__b);
}
...
///     lower 32-bit values is NaN, 0 is returned.
static __inline__ int __DEFAULT_FN_ATTRS
sse_ucomile_ss(vec4f __a, vec4f __b)
{
    return __builtin_ia32_ucomile((vec4f32_unaligned)__a, (vec4f32_unaligned)__b);
}
...
///     lower 32-bit values is NaN, 0 is returned.
static __inline__ int __DEFAULT_FN_ATTRS
sse_ucomigt_ss(vec4f __a, vec4f __b)
{
    return __builtin_ia32_ucomigt((vec4f32_unaligned)__a, (vec4f32_unaligned)__b);
}
...
///     lower 32-bit values is NaN, 0 is returned.
static __inline__ int __DEFAULT_FN_ATTRS
sse_ucomige_ss(vec4f __a, vec4f __b)
{
    return __builtin_ia32_ucomige((vec4f32_unaligned)__a, (vec4f32_unaligned)__b);
}
...
static __inline__ int __DEFAULT_FN_ATTRS
sse_ucomineq_ss(vec4f __a, vec4f __b)
{
    return __builtin_ia32_ucomineq((vec4f32_unaligned)__a, (vec4f32_unaligned)__b);
}
...
static __inline__ int __DEFAULT_FN_ATTRS
sse_cvtss_si32(vec4f __a)
{
    return __builtin_ia32_cvtss2si((vec4f32_unaligned)__a);
}
...
/// \returns A 32-bit integer containing the converted value.
static __inline__ int __DEFAULT_FN_ATTRS
sse_cvt_ss2si(vec4f __a)
{
    return sse_cvtss_si32(__a);
}
...
sse_cvtss_si64(vec4f __a)
{
    return __builtin_ia32_cvtss2si64((vec4f32_unaligned)__a);
}
...
static __inline__ vec1s64 __DEFAULT_FN_ATTRS_MMX
sse_cvtps_pi32(vec4f __a)
{
    return (vec1s64)__builtin_ia32_cvtps2pi((vec4f32_unaligned)__a);
}
...
/// \returns A 64-bit integer vector containing the converted values.
static __inline__ vec1s64 __DEFAULT_FN_ATTRS_MMX
sse_cvt_ps2pi(vec4f __a)
{
    return sse_cvtps_pi32(__a);
}
...
/// \returns A 32-bit integer containing the converted value.
static __inline__ int __DEFAULT_FN_ATTRS
sse_cvttss_si32(vec4f __a)
{
    return __builtin_ia32_cvttss2si((vec4f32_unaligned)__a);
}
...
/// \returns A 32-bit integer containing the converted value.
static __inline__ int __DEFAULT_FN_ATTRS
sse_cvtt_ss2si(vec4f __a)
{
    return sse_cvttss_si32(__a);
}
...
/// \returns A 64-bit integer containing the converted value.
static __inline__ long long __DEFAULT_FN_ATTRS
sse_cvttss_si64(vec4f __a)
{
    return __builtin_ia32_cvttss2si64((vec4f32_unaligned)__a);
}
#endif
...
/// \returns A 64-bit integer vector containing the converted values.
static __inline__ vec1s64 __DEFAULT_FN_ATTRS_MMX
sse_cvttps_pi32(vec4f __a)
{
    return (vec1s64)__builtin_ia32_cvttps2pi((vec4f32_unaligned)__a);
}
...
/// \returns A 64-bit integer vector containing the converted values.
static __inline__ vec1s64 __DEFAULT_FN_ATTRS_MMX
sse_cvtt_ps2pi(vec4f __a)
{
    return sse_cvttps_pi32(__a);
}
...
static __inline__ vec4f __DEFAULT_FN_ATTRS
sse_cvtsi32_ss(vec4f __a, int __b)
{
    __a[0] = __b;
    return __a;
}
...
///    the upper 96 bits of the first operand.
static __inline__ vec4f __DEFAULT_FN_ATTRS
sse_cvt_si2ss(vec4f __a, int __b)
{
    return sse_cvtsi32_ss(__a, __b);
}
...
///    the upper 96 bits of the first operand.
static __inline__ vec4f __DEFAULT_FN_ATTRS
sse_cvtsi64_ss(vec4f __a, long long __b)
{
    __a[0] = __b;
    return __a;
}
...
static __inline__ vec4f __DEFAULT_FN_ATTRS_MMX
sse_cvtpi32_ps(vec4f __a, vec1s64 __b)
{
    return __builtin_ia32_cvtpi2ps((vec4f32_unaligned)__a, (vec2s32)__b);
}
...
static __inline__ vec4f __DEFAULT_FN_ATTRS_MMX
sse_cvt_pi2ps(vec4f __a, vec1s64 __b)
{
    return sse_cvtpi32_ps(__a, __b);
}
...
static __inline__ vec4f __DEFAULT_FN_ATTRS
sse_loadh_pi(vec4f __a, const vec1s64 *__p)
{
    typedef float _sse_loadh_pi_v2f32 __attribute__((__vector_size__(8)));
    struct _sse_loadh_pi_struct {
        _sse_loadh_pi_v2f32 __u;
    } __attribute__((__packed__, __may_alias__));
    _sse_loadh_pi_v2f32 __b = ((struct _sse_loadh_pi_struct*)__p)->__u;
    vec4f __bb = __builtin_shufflevector(__b, __b, 0, 1, 0, 1);
...
/// \returns A 128-bit vector of [4 x float] containing the moved values.
static __inline__ vec4f __DEFAULT_FN_ATTRS
sse_loadl_pi(vec4f __a, const vec1s64 *__p)
{
    typedef float _sse_loadl_pi_v2f32 __attribute__((__vector_size__(8)));
    struct _sse_loadl_pi_struct {
        _sse_loadl_pi_v2f32 __u;
    } __attribute__((__packed__, __may_alias__));
    _sse_loadl_pi_v2f32 __b = ((struct _sse_loadl_pi_struct*)__p)->__u;
    vec4f __bb = __builtin_shufflevector(__b, __b, 0, 1, 0, 1);
...
static __inline__ vec4f __DEFAULT_FN_ATTRS
sse_load_ss(const float *__p)
{
    struct _sse_load_ss_struct {
        float __u;
    } __attribute__((__packed__, __may_alias__));
    float __u = ((struct _sse_load_ss_struct*)__p)->__u;
    return __extension__ (vec4f){ __u, 0, 0, 0 };
}
...
///    duplicated values.
static __inline__ vec4f __DEFAULT_FN_ATTRS
sse_load1_ps(const float *__p)
{
    struct _sse_load1_ps_struct {
        float __u;
    } __attribute__((__packed__, __may_alias__));
    float __u = ((struct _sse_load1_ps_struct*)__p)->__u;
    return __extension__ (vec4f){ __u, __u, __u, __u };
}

#define        sse_load_ps1(p) sse_load1_ps(p)
...
///    in reverse order.
static __inline__ vec4f __DEFAULT_FN_ATTRS
sse_loadr_ps(const float *__p)
{
    vec4f __a = sse_load_ps(__p);
    return __builtin_shufflevector((vec4f32_unaligned)__a, (vec4f32_unaligned)__a, 3, 2, 1, 0);
}
...
static __inline__ vec4f __DEFAULT_FN_ATTRS
sse_undefined_ps(void)
{
    return (vec4f)__builtin_ia32_undef128();
}
...
///    upper 96 bits are set to zero.
static __inline__ vec4f __DEFAULT_FN_ATTRS
sse_set_ss(float __w)
{
    return __extension__ (vec4f){ __w, 0, 0, 0 };
}
...
static __inline__ vec4f __DEFAULT_FN_ATTRS
sse_set1_ps(float __w)
{
    return __extension__ (vec4f){ __w, __w, __w, __w };
}
...
/// \returns An initialized 128-bit floating-point vector of [4 x float].
static __inline__ vec4f __DEFAULT_FN_ATTRS
sse_set_ps1(float __w)
{
    return sse_set1_ps(__w);
}
...
/// \returns An initialized 128-bit floating-point vector of [4 x float].
static __inline__ vec4f __DEFAULT_FN_ATTRS
sse_set_ps(float __z, float __y, float __x, float __w)
{
    return __extension__ (vec4f){ __w, __x, __y, __z };
}
...
/// \returns An initialized 128-bit floating-point vector of [4 x float].
static __inline__ vec4f __DEFAULT_FN_ATTRS
sse_setr_ps(float __z, float __y, float __x, float __w)
{
    return __extension__ (vec4f){ __z, __y, __x, __w };
}
...
sse_setzero_ps(void)
{
    return __extension__ (vec4f){ 0, 0, 0, 0 };
}
...
sse_storeh_pi(vec1s64 *__p, vec4f __a)
{
    typedef float _sse_storeh_pi_v2f32 __attribute__((__vector_size__(8)));
    struct _sse_storeh_pi_struct {
        _sse_storeh_pi_v2f32 __u;
    } __attribute__((__packed__, __may_alias__));
    ((struct _sse_storeh_pi_struct*)__p)->__u = __builtin_shufflevector(__a, __a, 2, 3);
}
...
///    A 128-bit vector of [4 x float] containing the values to be stored.
static __inline__ void __DEFAULT_FN_ATTRS
sse_storel_pi(vec1s64 *__p, vec4f __a)
{
    typedef float _sse_storeh_pi_v2f32 __attribute__((__vector_size__(8)));
    struct _sse_storeh_pi_struct {
        _sse_storeh_pi_v2f32 __u;
    } __attribute__((__packed__, __may_alias__));
    ((struct _sse_storeh_pi_struct*)__p)->__u = __builtin_shufflevector(__a, __a, 0, 1);
}
...
static __inline__ void __DEFAULT_FN_ATTRS
sse_store_ss(float *__p, vec4f __a)
{
    struct _sse_store_ss_struct {
        float __u;
    } __attribute__((__packed__, __may_alias__));
    ((struct _sse_store_ss_struct*)__p)->__u = __a[0];
}
...
///    A 128-bit vector of [4 x float] containing the values to be stored.
static __inline__ void __DEFAULT_FN_ATTRS
sse_storeu_ps(float *__p, vec4f __a)
{
    struct __storeu_ps {
        vec4f_u __v;
    } __attribute__((__packed__, __may_alias__));
...
///    A 128-bit vector of [4 x float] containing the values to be stored.
static __inline__ void __DEFAULT_FN_ATTRS
sse_store_ps(float *__p, vec4f __a)
{
    *(vec4f*)__p = __a;
}
...
static __inline__ void __DEFAULT_FN_ATTRS
sse_store1_ps(float *__p, vec4f __a)
{
    __a = __builtin_shufflevector((vec4f32_unaligned)__a, (vec4f32_unaligned)__a, 0, 0, 0, 0);
    sse_store_ps(__p, __a);
}
...
///    of the four contiguous elements pointed by \a __p.
static __inline__ void __DEFAULT_FN_ATTRS
sse_store_ps1(float *__p, vec4f __a)
{
    sse_store1_ps(__p, __a);
}
...
///    A 128-bit vector of [4 x float] containing the values to be stored.
static __inline__ void __DEFAULT_FN_ATTRS
sse_storer_ps(float *__p, vec4f __a)
{
    __a = __builtin_shufflevector((vec4f32_unaligned)__a, (vec4f32_unaligned)__a, 3, 2, 1, 0);
    sse_store_ps(__p, __a);
}
...
///
/// \code
/// void sse_prefetch(const void * a, const int sel);
/// \endcode
///
...
///    be generated.
#define sse_prefetch(a, sel) (__builtin_prefetch((void *)(a), \
                                                 ((sel) >> 2) & 1, (sel) & 0x3))
#endif
...
sse_stream_pi(vec1s64 *__p, vec1s64 __a)
{
...
static __inline__ void __DEFAULT_FN_ATTRS
sse_stream_ps(float *__p, vec4f __a)
{
    __builtin_nontemporal_store((vec4f32_unaligned)__a, (vec4f32_unaligned*)__p);
}
...
///
/// \code
/// int sse_extract_pi16(vec1s64 a, int n);
/// \endcode
///
...
#define sse_extract_pi16(a, n) \
  (int)__builtin_ia32_vec_ext_v4hi((vec1s64)a, (int)n)
...
///
/// \code
/// vec1s64 sse_insert_pi16(vec1s64 a, int d, int n);
/// \endcode
///
...
///    operands.
#define sse_insert_pi16(a, d, n) \
  (vec1s64)__builtin_ia32_vec_set_v4hi((vec1s64)a, (int)d, (int)n)
...
static __inline__ vec1s64 __DEFAULT_FN_ATTRS_MMX
sse_max_pi16(vec1s64 __a, vec1s64 __b)
{
    return (vec1s64)__builtin_ia32_pmaxsw((vec4s16)__a, (vec4s16)__b);
}
...
/// \returns A 64-bit integer vector containing the comparison results.
static __inline__ vec1s64 __DEFAULT_FN_ATTRS_MMX
sse_max_pu8(vec1s64 __a, vec1s64 __b)
{
    return (vec1s64)__builtin_ia32_pmaxub((vec8s8)__a, (vec8s8)__b);
}
...
/// \returns A 64-bit integer vector containing the comparison results.
static __inline__ vec1s64 __DEFAULT_FN_ATTRS_MMX
sse_min_pi16(vec1s64 __a, vec1s64 __b)
{
    return (vec1s64)__builtin_ia32_pminsw((vec4s16)__a, (vec4s16)__b);
}
...
/// \returns A 64-bit integer vector containing the comparison results.
static __inline__ vec1s64 __DEFAULT_FN_ATTRS_MMX
sse_min_pu8(vec1s64 __a, vec1s64 __b)
{
    return (vec1s64)__builtin_ia32_pminub((vec8s8)__a, (vec8s8)__b);
}
...
sse_movemask_pi8(vec1s64 __a)
{
    return __builtin_ia32_pmovmskb((vec8s8)__a);
}
...
static __inline__ vec1s64 __DEFAULT_FN_ATTRS_MMX
sse_mulhi_pu16(vec1s64 __a, vec1s64 __b)
{
    return (vec1s64)__builtin_ia32_pmulhuw((vec4s16)__a, (vec4s16)__b);
}
...
///
/// \code
/// vec1s64 sse_shuffle_pi16(__m64 a, const int n);
/// \endcode
///
...
#define sse_shuffle_pi16(a, n) \
  (vec1s64)__builtin_ia32_pshufw((__v4hi)(vec1s64)(a), (n))
...
///    to be aligned.
static __inline__ void __DEFAULT_FN_ATTRS_MMX
sse_maskmove_si64(vec1s64 __d, vec1s64 __n, char *__p)
{
    __builtin_ia32_maskmovq((vec8s8)__d, (vec8s8)__n, __p);
}
...
static __inline__ vec1s64 __DEFAULT_FN_ATTRS_MMX
sse_avg_pu8(vec1s64 __a, vec1s64 __b)
{
    return (vec1s64)__builtin_ia32_pavgb((vec8s8)__a, (vec8s8)__b);
}
...
/// \returns A 64-bit integer vector containing the averages of both operands.
static __inline__ vec1s64 __DEFAULT_FN_ATTRS_MMX
sse_avg_pu16(vec1s64 __a, vec1s64 __b)
{
    return (vec1s64)__builtin_ia32_pavgw((vec4s16)__a, (vec4s16)__b);
}
...
///    cleared.
static __inline__ vec1s64 __DEFAULT_FN_ATTRS_MMX
sse_sad_pu8(vec1s64 __a, vec1s64 __b)
{
    return (vec1s64)__builtin_ia32_psadbw((vec8s8)__a, (vec8s8)__b);
}
...
///    occurred:
///    \code
///      ( sse_getcsr() & _MM_EXCEPT_OVERFLOW )
///    \endcode
///
...
///      sse_setcsr(sse_getcsr() | _MM_ROUND_UP)
///
...
void sse_setcsr(unsigned int __i);
...
///
/// \code
/// vec4f sse_shuffle_ps(vec4f a, vec4f b, const int mask);
/// \endcode
///
...
#define sse_shuffle_ps(a, b, mask) \
  (vec4f)__builtin_ia32_shufps((vec4f32_unaligned)(vec4f)(a), (vec4f32_unaligned)(vec4f)(b), \
                                (int)(mask))
...
static __inline__ vec4f __DEFAULT_FN_ATTRS
sse_unpackhi_ps(vec4f __a, vec4f __b)
{
    return __builtin_shufflevector((vec4f32_unaligned)__a, (vec4f32_unaligned)__b, 2, 6, 3, 7);
}
...
/// \returns A 128-bit vector of [4 x float] containing the interleaved values.
static __inline__ vec4f __DEFAULT_FN_ATTRS
sse_unpacklo_ps(vec4f __a, vec4f __b)
{
    return __builtin_shufflevector((vec4f32_unaligned)__a, (vec4f32_unaligned)__b, 0, 4, 1, 5);
}
...
static __inline__ vec4f __DEFAULT_FN_ATTRS
sse_move_ss(vec4f __a, vec4f __b)
{
    __a[0] = __b[0];
    return __a;
}
...
/// \returns A 128-bit floating-point vector of [4 x float].
static __inline__ vec4f __DEFAULT_FN_ATTRS
sse_movehl_ps(vec4f __a, vec4f __b)
{
    return __builtin_shufflevector((vec4f32_unaligned)__a, (vec4f32_unaligned)__b, 6, 7, 2, 3);
}
...
/// \returns A 128-bit floating-point vector of [4 x float].
static __inline__ vec4f __DEFAULT_FN_ATTRS
sse_movelh_ps(vec4f __a, vec4f __b)
{
    return __builtin_shufflevector((vec4f32_unaligned)__a, (vec4f32_unaligned)__b, 0, 1, 4, 5);
}
...
static __inline__ vec4f __DEFAULT_FN_ATTRS_MMX
sse_cvtpi16_ps(vec1s64 __a)
{
    vec1s64 __b, __c;
    vec4f __r;

    __b = mmx_setzero_si64();
    __b = mmx_cmpgt_pi16(__b, __a);
    __c = mmx_unpackhi_pi16(__a, __b);
    __r = sse_setzero_ps();
    __r = sse_cvtpi32_ps(__r, __c);
    __r = sse_movelh_ps(__r, __r);
    __c = mmx_unpacklo_pi16(__a, __b);
    __r = sse_cvtpi32_ps(__r, __c);
...
///    values from the operand.
static __inline__ vec4f __DEFAULT_FN_ATTRS_MMX
sse_cvtpi8_ps(vec1s64 __a)
{
    vec1s64 __b;

    __b = mmx_setzero_si64();
    __b = mmx_cmpgt_pi8(__b, __a);
    __b = mmx_unpacklo_pi8(__a, __b);

    return sse_cvtpi16_ps(__b);
}
...
static __inline__ vec4f __DEFAULT_FN_ATTRS_MMX
sse_cvtpi32x2_ps(vec1s64 __a, vec1s64 __b)
{
    vec4f __c;

    __c = sse_setzero_ps();
    __c = sse_cvtpi32_ps(__c, __b);
    __c = sse_movelh_ps(__c, __c);

    return sse_cvtpi32_ps(__c, __a);
}
...
///    values.
static __inline__ vec1s64 __DEFAULT_FN_ATTRS_MMX
sse_cvtps_pi16(vec4f __a)
{
    vec1s64 __b, __c;

    __b = sse_cvtps_pi32(__a);
    __a = sse_movehl_ps(__a, __a);
    __c = sse_cvtps_pi32(__a);

    return mmx_packs_pi32(__b, __c);
}
...
static __inline__ vec1s64 __DEFAULT_FN_ATTRS_MMX
sse_cvtps_pi8(vec4f __a)
{
    vec1s64 __b, __c;

    __b = sse_cvtps_pi16(__a);
    __c = mmx_setzero_si64();

    return mmx_packs_pi16(__b, __c);
}
...
///    set to zero.
static __inline__ int __DEFAULT_FN_ATTRS
sse_movemask_ps(vec4f __a)
{
    return __builtin_ia32_movmskps((vec4f32_unaligned)__a);
}
...
#define _MM_GET_EXCEPTION_MASK() (sse_getcsr() & _MM_MASK_MASK)
#define _MM_GET_EXCEPTION_STATE() (sse_getcsr() & _MM_EXCEPT_MASK)
#define _MM_GET_FLUSH_ZERO_MODE() (sse_getcsr() & _MM_FLUSH_ZERO_MASK)
#define _MM_GET_ROUNDING_MODE() (sse_getcsr() & _MM_ROUND_MASK)

#define _MM_SET_EXCEPTION_MASK(x) (sse_setcsr((sse_getcsr() & ~_MM_MASK_MASK) | (x)))
#define _MM_SET_EXCEPTION_STATE(x) (sse_setcsr((sse_getcsr() & ~_MM_EXCEPT_MASK) | (x)))
#define _MM_SET_FLUSH_ZERO_MODE(x) (sse_setcsr((sse_getcsr() & ~_MM_FLUSH_ZERO_MASK) | (x)))
#define _MM_SET_ROUNDING_MODE(x) (sse_setcsr((sse_getcsr() & ~_MM_ROUND_MASK) | (x)))

#define _MM_TRANSPOSE4_PS(row0, row1, row2, row3) \
do { \
  vec4f tmp3, tmp2, tmp1, tmp0; \
  tmp0 = sse_unpacklo_ps((row0), (row1)); \
  tmp2 = sse_unpacklo_ps((row2), (row3)); \
  tmp1 = sse_unpackhi_ps((row0), (row1)); \
  tmp3 = sse_unpackhi_ps((row2), (row3)); \
  (row0) = sse_movelh_ps(tmp0, tmp2); \
  (row1) = sse_movehl_ps(tmp2, tmp0); \
  (row2) = sse_movelh_ps(tmp1, tmp3); \
  (row3) = sse_movehl_ps(tmp3, tmp1); \
} while (0)

/* Aliases for compatibility. */
#define _m_pextrw sse_extract_pi16
#define _m_pinsrw sse_insert_pi16
#define _m_pmaxsw sse_max_pi16
#define _m_pmaxub sse_max_pu8
#define _m_pminsw sse_min_pi16
#define _m_pminub sse_min_pu8
#define _m_pmovmskb sse_movemask_pi8
#define _m_pmulhuw sse_mulhi_pu16
#define _m_pshufw sse_shuffle_pi16
#define _m_maskmovq sse_maskmove_si64
#define _m_pavgb sse_avg_pu8
#define _m_pavgw sse_avg_pu16
#define _m_psadbw sse_sad_pu8
#define _m_ sse_
#define _m_ sse_
