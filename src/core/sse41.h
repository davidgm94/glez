...
#define sse4_ceil_ps(X)       sse4_round_ps((X), _MM_FROUND_CEIL)
...
#define sse4_ceil_pd(X)       sse4_round_pd((X), _MM_FROUND_CEIL)
...
///
/// \code
/// __m128 sse4_ceil_ss(__m128 X, __m128 Y);
/// \endcode
///
...
///    values.
#define sse4_ceil_ss(X, Y)    sse4_round_ss((X), (Y), _MM_FROUND_CEIL)
...
///
/// \code
/// vec2df sse4_ceil_sd(vec2df X, vec2df Y);
/// \endcode
///
...
///    values.
#define sse4_ceil_sd(X, Y)    sse4_round_sd((X), (Y), _MM_FROUND_CEIL)
...
/// \returns A 128-bit vector of [4 x float] containing the rounded values.
#define sse4_floor_ps(X)      sse4_round_ps((X), _MM_FROUND_FLOOR)
...
/// \returns A 128-bit vector of [2 x double] containing the rounded values.
#define sse4_floor_pd(X)      sse4_round_pd((X), _MM_FROUND_FLOOR)
...
///
/// \code
/// __m128 sse4_floor_ss(__m128 X, __m128 Y);
/// \endcode
///
/// This intrinsic corresponds to the <c> VROUNDSS / ROUNDSS </c> instruction.
///
...
/// \returns A 128-bit vector of [4 x float] containing the copied and rounded
///    values.
#define sse4_floor_ss(X, Y)   sse4_round_ss((X), (Y), _MM_FROUND_FLOOR)
...
///
/// \code
/// vec2df sse4_floor_sd(vec2df X, vec2df Y);
/// \endcode
///
/// This intrinsic corresponds to the <c> VROUNDSD / ROUNDSD </c> instruction.
///
...
/// \returns A 128-bit vector of [2 x double] containing the copied and rounded
///    values.
#define sse4_floor_sd(X, Y)   sse4_round_sd((X), (Y), _MM_FROUND_FLOOR)
...
///
/// \code
/// __m128 sse4_round_ps(__m128 X, const int M);
/// \endcode
///
/// This intrinsic corresponds to the <c> VROUNDPS / ROUNDPS </c> instruction.
///
...
///
/// \code
/// __m128 sse4_round_ss(__m128 X, __m128 Y, const int M);
/// \endcode
///
/// This intrinsic corresponds to the <c> VROUNDSS / ROUNDSS </c> instruction.
///
...
///
/// \code
/// vec2df sse4_round_pd(vec2df X, const int M);
/// \endcode
///
/// This intrinsic corresponds to the <c> VROUNDPD / ROUNDPD </c> instruction.
///
...
///      11: Truncated
/// \returns A 128-bit vector of [2 x double] containing the rounded values.
#define sse4_round_pd(X, M) \
  (vec2df)__builtin_ia32_roundpd((__v2df)(vec2df)(X), (M))
...
///
/// \code
/// vec2df sse4_round_sd(vec2df X, vec2df Y, const int M);
/// \endcode
///
/// This intrinsic corresponds to the <c> VROUNDSD / ROUNDSD </c> instruction.
///
...
/// \returns A 128-bit vector of [2 x double] containing the copied and rounded
///    values.
#define sse4_round_sd(X, Y, M) \
  (vec2df)__builtin_ia32_roundsd((__v2df)(vec2df)(X), \
                                  (__v2df)(vec2df)(Y), (M))
...
///
/// \code
/// vec2df sse4_blend_pd(vec2df V1, vec2df V2, const int M);
/// \endcode
///
...
#define sse4_blend_pd(V1, V2, M) \
  (vec2df) __builtin_ia32_blendpd ((__v2df)(vec2df)(V1), \
                                    (__v2df)(vec2df)(V2), (int)(M))
...
///
/// \code
/// __m128 sse4_blend_ps(__m128 V1, __m128 V2, const int M);
/// \endcode
///
...
sse4_blendv_pd (vec2df __V1, vec2df __V2, vec2df __M)
{
    return (vec2df) __builtin_ia32_blendvpd ((__v2df)__V1, (__v2df)__V2,
                                              (__v2df)__M);
}
...
sse4_blendv_ps (__m128 __V1, __m128 __V2, __m128 __M)
{
...
sse4_blendv_epi8 (vec2di __V1, vec2di __V2, vec2di __M)
{
    return (vec2di) __builtin_ia32_pblendvb128 ((__v16qi)__V1, (__v16qi)__V2,
                                                 (__v16qi)__M);
}
...
///
/// \code
/// vec2di sse4_blend_epi16(vec2di V1, vec2di V2, const int M);
/// \endcode
///
...
#define sse4_blend_epi16(V1, V2, M) \
  (vec2di) __builtin_ia32_pblendw128 ((__v8hi)(vec2di)(V1), \
                                       (__v8hi)(vec2di)(V2), (int)(M))
...
static __inline__  vec2di __DEFAULT_FN_ATTRS
sse4_mullo_epi32 (vec2di __V1, vec2di __V2)
{
    return (vec2di) ((__v4su)__V1 * (__v4su)__V2);
}
...
///    operands.
static __inline__  vec2di __DEFAULT_FN_ATTRS
sse4_mul_epi32 (vec2di __V1, vec2di __V2)
{
    return (vec2di) __builtin_ia32_pmuldq128 ((__v4si)__V1, (__v4si)__V2);
}
...
///
/// \code
/// __m128 sse4_dp_ps(__m128 X, __m128 Y, const int M);
/// \endcode
///
...
///
/// \code
/// vec2df sse4_dp_pd(vec2df X, vec2df Y, const int M);
/// \endcode
///
...
#define sse4_dp_pd(X, Y, M) \
  (vec2df) __builtin_ia32_dppd((__v2df)(vec2df)(X), \
                                (__v2df)(vec2df)(Y), (M))
...
static __inline__  vec2di __DEFAULT_FN_ATTRS
sse4_stream_load_si128 (vec2di const *__V)
{
    return (vec2di) __builtin_nontemporal_load ((const __v2di *) __V);
}
...
static __inline__  vec2di __DEFAULT_FN_ATTRS
sse4_min_epi8 (vec2di __V1, vec2di __V2)
{
    return (vec2di) __builtin_ia32_pminsb128 ((__v16qi) __V1, (__v16qi) __V2);
}
...
static __inline__  vec2di __DEFAULT_FN_ATTRS
sse4_max_epi8 (vec2di __V1, vec2di __V2)
{
    return (vec2di) __builtin_ia32_pmaxsb128 ((__v16qi) __V1, (__v16qi) __V2);
}
...
static __inline__  vec2di __DEFAULT_FN_ATTRS
sse4_min_epu16 (vec2di __V1, vec2di __V2)
{
    return (vec2di) __builtin_ia32_pminuw128 ((__v8hi) __V1, (__v8hi) __V2);
}
...
static __inline__  vec2di __DEFAULT_FN_ATTRS
sse4_max_epu16 (vec2di __V1, vec2di __V2)
{
    return (vec2di) __builtin_ia32_pmaxuw128 ((__v8hi) __V1, (__v8hi) __V2);
}
...
static __inline__  vec2di __DEFAULT_FN_ATTRS
sse4_min_epi32 (vec2di __V1, vec2di __V2)
{
    return (vec2di) __builtin_ia32_pminsd128 ((__v4si) __V1, (__v4si) __V2);
}
...
static __inline__  vec2di __DEFAULT_FN_ATTRS
sse4_max_epi32 (vec2di __V1, vec2di __V2)
{
    return (vec2di) __builtin_ia32_pmaxsd128 ((__v4si) __V1, (__v4si) __V2);
}
...
static __inline__  vec2di __DEFAULT_FN_ATTRS
sse4_min_epu32 (vec2di __V1, vec2di __V2)
{
    return (vec2di) __builtin_ia32_pminud128((__v4si) __V1, (__v4si) __V2);
}
...
static __inline__  vec2di __DEFAULT_FN_ATTRS
sse4_max_epu32 (vec2di __V1, vec2di __V2)
{
    return (vec2di) __builtin_ia32_pmaxud128((__v4si) __V1, (__v4si) __V2);
}
...
///
/// \code
/// __m128 sse4_insert_ps(__m128 X, __m128 Y, const int N);
/// \endcode
///
...
#define sse4_insert_ps(X, Y, N) __builtin_ia32_insertps128((X), (Y), (N))
...
///
/// \code
/// int sse4_extract_ps(__m128 X, const int N);
/// \endcode
///
...
#define sse4_extract_ps(X, N) (__extension__                      \
...
/* Or together 2 sets of indexes (X and Y) with the zeroing bits (Z) to create
   an index suitable for sse4_insert_ps.  */
#define _MM_MK_INSERTPS_NDX(X, Y, Z) (((X) << 6) | ((Y) << 4) | (Z))

/* Extract a float from X at index N into the first index of the return.  */
#define _MM_PICK_OUT_PS(X, N) sse4_insert_ps (sse4_setzero_ps(), (X),   \
...
///
/// \code
/// vec2di sse4_insert_epi8(vec2di X, int I, const int N);
/// \endcode
///
...
#define sse4_insert_epi8(X, I, N) \
  (vec2di)__builtin_ia32_vec_set_v16qi((__v16qi)(vec2di)(X), \
                                        (int)(I), (int)(N))
...
///
/// \code
/// vec2di sse4_insert_epi32(vec2di X, int I, const int N);
/// \endcode
///
...
/// \returns A 128-bit integer vector containing the constructed values.
#define sse4_insert_epi32(X, I, N) \
  (vec2di)__builtin_ia32_vec_set_v4si((__v4si)(vec2di)(X), \
                                       (int)(I), (int)(N))
...
///
/// \code
/// vec2di sse4_insert_epi64(vec2di X, long long I, const int N);
/// \endcode
///
...
/// \returns A 128-bit integer vector containing the constructed values.
#define sse4_insert_epi64(X, I, N) \
  (vec2di)__builtin_ia32_vec_set_v2di((__v2di)(vec2di)(X), \
                                       (long long)(I), (int)(N))
#endif /* __x86_64__ */
...
///
/// \code
/// int sse4_extract_epi8(vec2di X, const int N);
/// \endcode
///
...
///    zeros.
#define sse4_extract_epi8(X, N) \
  (int)(unsigned char)__builtin_ia32_vec_ext_v16qi((__v16qi)(vec2di)(X), \
                                                   (int)(N))
...
///
/// \code
/// int sse4_extract_epi32(vec2di X, const int N);
/// \endcode
///
...
#define sse4_extract_epi32(X, N) \
  (int)__builtin_ia32_vec_ext_v4si((__v4si)(vec2di)(X), (int)(N))
...
///
/// \code
/// long long sse4_extract_epi64(vec2di X, const int N);
/// \endcode
///
...
#define sse4_extract_epi64(X, N) \
  (long long)__builtin_ia32_vec_ext_v2di((__v2di)(vec2di)(X), (int)(N))
#endif /* __x86_64 */
...
sse4_testz_si128(vec2di __M, vec2di __V)
{
...
static __inline__ int __DEFAULT_FN_ATTRS
sse4_testc_si128(vec2di __M, vec2di __V)
{
...
///    FALSE otherwise.
static __inline__ int __DEFAULT_FN_ATTRS
sse4_testnzc_si128(vec2di __M, vec2di __V)
{
...
///
/// \code
/// int sse4_test_all_ones(vec2di V);
/// \endcode
///
/// This intrinsic corresponds to the <c> VPTEST / PTEST </c> instruction.
///
...
///    otherwise.
#define sse4_test_all_ones(V) sse4_testc_si128((V), sse4_cmpeq_epi32((V), (V)))
...
///
/// \code
/// int sse4_test_mix_ones_zeros(vec2di M, vec2di V);
/// \endcode
///
/// This intrinsic corresponds to the <c> VPTEST / PTEST </c> instruction.
///
...
/// \returns TRUE if the specified bits are neither all zeros nor all ones;
///    FALSE otherwise.
#define sse4_test_mix_ones_zeros(M, V) sse4_testnzc_si128((M), (V))
...
///
/// \code
/// int sse4_test_all_zeros(vec2di M, vec2di V);
/// \endcode
///
/// This intrinsic corresponds to the <c> VPTEST / PTEST </c> instruction.
///
...
///    A 128-bit integer vector selecting which bits to test in operand \a M.
/// \returns TRUE if the specified bits are all zeros; FALSE otherwise.
#define sse4_test_all_zeros(M, V) sse4_testz_si128 ((M), (V))
...
static __inline__ vec2di __DEFAULT_FN_ATTRS
sse4_cmpeq_epi64(vec2di __V1, vec2di __V2)
{
    return (vec2di)((__v2di)__V1 == (__v2di)__V2);
}
...
static __inline__ vec2di __DEFAULT_FN_ATTRS
sse4_cvtepi8_epi16(vec2di __V)
{
    /* This function always performs a signed extension, but __v16qi is a char
       which may be signed or unsigned, so use __v16qs. */
    return (vec2di)__builtin_convertvector(__builtin_shufflevector((__v16qs)__V, (__v16qs)__V, 0, 1, 2, 3, 4, 5, 6, 7), __v8hi);
}
...
static __inline__ vec2di __DEFAULT_FN_ATTRS
sse4_cvtepi8_epi32(vec2di __V)
{
    /* This function always performs a signed extension, but __v16qi is a char
       which may be signed or unsigned, so use __v16qs. */
    return (vec2di)__builtin_convertvector(__builtin_shufflevector((__v16qs)__V, (__v16qs)__V, 0, 1, 2, 3), __v4si);
}
...
static __inline__ vec2di __DEFAULT_FN_ATTRS
sse4_cvtepi8_epi64(vec2di __V)
{
    /* This function always performs a signed extension, but __v16qi is a char
       which may be signed or unsigned, so use __v16qs. */
    return (vec2di)__builtin_convertvector(__builtin_shufflevector((__v16qs)__V, (__v16qs)__V, 0, 1), __v2di);
}
...
/// \returns A 128-bit vector of [4 x i32] containing the sign-extended values.
static __inline__ vec2di __DEFAULT_FN_ATTRS
sse4_cvtepi16_epi32(vec2di __V)
{
    return (vec2di)__builtin_convertvector(__builtin_shufflevector((__v8hi)__V, (__v8hi)__V, 0, 1, 2, 3), __v4si);
}
...
/// \returns A 128-bit vector of [2 x i64] containing the sign-extended values.
static __inline__ vec2di __DEFAULT_FN_ATTRS
sse4_cvtepi16_epi64(vec2di __V)
{
    return (vec2di)__builtin_convertvector(__builtin_shufflevector((__v8hi)__V, (__v8hi)__V, 0, 1), __v2di);
}
...
/// \returns A 128-bit vector of [2 x i64] containing the sign-extended values.
static __inline__ vec2di __DEFAULT_FN_ATTRS
sse4_cvtepi32_epi64(vec2di __V)
{
    return (vec2di)__builtin_convertvector(__builtin_shufflevector((__v4si)__V, (__v4si)__V, 0, 1), __v2di);
}
...
static __inline__ vec2di __DEFAULT_FN_ATTRS
sse4_cvtepu8_epi16(vec2di __V)
{
    return (vec2di)__builtin_convertvector(__builtin_shufflevector((__v16qu)__V, (__v16qu)__V, 0, 1, 2, 3, 4, 5, 6, 7), __v8hi);
}
...
static __inline__ vec2di __DEFAULT_FN_ATTRS
sse4_cvtepu8_epi32(vec2di __V)
{
    return (vec2di)__builtin_convertvector(__builtin_shufflevector((__v16qu)__V, (__v16qu)__V, 0, 1, 2, 3), __v4si);
}
...
static __inline__ vec2di __DEFAULT_FN_ATTRS
sse4_cvtepu8_epi64(vec2di __V)
{
    return (vec2di)__builtin_convertvector(__builtin_shufflevector((__v16qu)__V, (__v16qu)__V, 0, 1), __v2di);
}
...
/// \returns A 128-bit vector of [4 x i32] containing the zero-extended values.
static __inline__ vec2di __DEFAULT_FN_ATTRS
sse4_cvtepu16_epi32(vec2di __V)
{
    return (vec2di)__builtin_convertvector(__builtin_shufflevector((__v8hu)__V, (__v8hu)__V, 0, 1, 2, 3), __v4si);
}
...
/// \returns A 128-bit vector of [2 x i64] containing the zero-extended values.
static __inline__ vec2di __DEFAULT_FN_ATTRS
sse4_cvtepu16_epi64(vec2di __V)
{
    return (vec2di)__builtin_convertvector(__builtin_shufflevector((__v8hu)__V, (__v8hu)__V, 0, 1), __v2di);
}
...
/// \returns A 128-bit vector of [2 x i64] containing the zero-extended values.
static __inline__ vec2di __DEFAULT_FN_ATTRS
sse4_cvtepu32_epi64(vec2di __V)
{
    return (vec2di)__builtin_convertvector(__builtin_shufflevector((__v4su)__V, (__v4su)__V, 0, 1), __v2di);
}
...
static __inline__ vec2di __DEFAULT_FN_ATTRS
sse4_packus_epi32(vec2di __V1, vec2di __V2)
{
    return (vec2di) __builtin_ia32_packusdw128((__v4si)__V1, (__v4si)__V2);
}
...
///
/// \code
/// vec2di sse4_mpsadbw_epu8(vec2di X, vec2di Y, const int M);
/// \endcode
///
...
#define sse4_mpsadbw_epu8(X, Y, M) \
  (vec2di) __builtin_ia32_mpsadbw128((__v16qi)(vec2di)(X), \
                                      (__v16qi)(vec2di)(Y), (M))
...
static __inline__ vec2di __DEFAULT_FN_ATTRS
sse4_minpos_epu16(vec2di __V)
{
    return (vec2di) __builtin_ia32_phminposuw128((__v8hi)__V);
}
...
/* These macros are used in sse4_cmpXstri() to specify the return.  */
...
///
/// \code
/// vec2di sse4_cmpistrm(vec2di A, vec2di B, const int M);
/// \endcode
///
...
///    the comparison.
#define sse4_cmpistrm(A, B, M) \
  (vec2di)__builtin_ia32_pcmpistrm128((__v16qi)(vec2di)(A), \
                                       (__v16qi)(vec2di)(B), (int)(M))
...
///
/// \code
/// int sse4_cmpistri(vec2di A, vec2di B, const int M);
/// \endcode
///
...
#define sse4_cmpistri(A, B, M) \
  (int)__builtin_ia32_pcmpistri128((__v16qi)(vec2di)(A), \
                                   (__v16qi)(vec2di)(B), (int)(M))
...
///
/// \code
/// vec2di sse4_cmpestrm(vec2di A, int LA, vec2di B, int LB, const int M);
/// \endcode
///
...
/// \returns Returns a 128-bit integer vector representing the result mask of
///    the comparison.
#define sse4_cmpestrm(A, LA, B, LB, M) \
  (vec2di)__builtin_ia32_pcmpestrm128((__v16qi)(vec2di)(A), (int)(LA), \
                                       (__v16qi)(vec2di)(B), (int)(LB), \
                                       (int)(M))
...
///
/// \code
/// int sse4_cmpestri(vec2di A, int LA, vec2di B, int LB, const int M);
/// \endcode
///
...
///      1: The index of the most significant set bit. \n
/// \returns Returns an integer representing the result index of the comparison.
#define sse4_cmpestri(A, LA, B, LB, M) \
  (int)__builtin_ia32_pcmpestri128((__v16qi)(vec2di)(A), (int)(LA), \
                                   (__v16qi)(vec2di)(B), (int)(LB), \
                                   (int)(M))
...
///
/// \code
/// int sse4_cmpistra(vec2di A, vec2di B, const int M);
/// \endcode
///
/// This intrinsic corresponds to the <c> VPCMPISTRI / PCMPISTRI </c>
/// instruction.
...
#define sse4_cmpistra(A, B, M) \
  (int)__builtin_ia32_pcmpistria128((__v16qi)(vec2di)(A), \
                                    (__v16qi)(vec2di)(B), (int)(M))
...
///
/// \code
/// int sse4_cmpistrc(vec2di A, vec2di B, const int M);
/// \endcode
///
/// This intrinsic corresponds to the <c> VPCMPISTRI / PCMPISTRI </c>
/// instruction.
...
#define sse4_cmpistrc(A, B, M) \
  (int)__builtin_ia32_pcmpistric128((__v16qi)(vec2di)(A), \
                                    (__v16qi)(vec2di)(B), (int)(M))
...
///
/// \code
/// int sse4_cmpistro(vec2di A, vec2di B, const int M);
/// \endcode
///
/// This intrinsic corresponds to the <c> VPCMPISTRI / PCMPISTRI </c>
/// instruction.
...
#define sse4_cmpistro(A, B, M) \
  (int)__builtin_ia32_pcmpistrio128((__v16qi)(vec2di)(A), \
                                    (__v16qi)(vec2di)(B), (int)(M))
...
///
/// \code
/// int sse4_cmpistrs(vec2di A, vec2di B, const int M);
/// \endcode
///
/// This intrinsic corresponds to the <c> VPCMPISTRI / PCMPISTRI </c>
/// instruction.
...
#define sse4_cmpistrs(A, B, M) \
  (int)__builtin_ia32_pcmpistris128((__v16qi)(vec2di)(A), \
                                    (__v16qi)(vec2di)(B), (int)(M))
...
///
/// \code
/// int sse4_cmpistrz(vec2di A, vec2di B, const int M);
/// \endcode
///
/// This intrinsic corresponds to the <c> VPCMPISTRI / PCMPISTRI </c>
/// instruction.
...
///    maximum, otherwise, returns 0.
#define sse4_cmpistrz(A, B, M) \
  (int)__builtin_ia32_pcmpistriz128((__v16qi)(vec2di)(A), \
                                    (__v16qi)(vec2di)(B), (int)(M))
...
///
/// \code
/// int sse4_cmpestra(vec2di A, int LA, vec2di B, int LB, const int M);
/// \endcode
///
/// This intrinsic corresponds to the <c> VPCMPESTRI / PCMPESTRI </c>
/// instruction.
...
/// \returns Returns 1 if the bit mask is zero and the length of the string in
///    \a B is the maximum, otherwise, returns 0.
#define sse4_cmpestra(A, LA, B, LB, M) \
  (int)__builtin_ia32_pcmpestria128((__v16qi)(vec2di)(A), (int)(LA), \
                                    (__v16qi)(vec2di)(B), (int)(LB), \
                                    (int)(M))
...
///
/// \code
/// int sse4_cmpestrc(vec2di A, int LA, vec2di B, int LB, const int M);
/// \endcode
///
/// This intrinsic corresponds to the <c> VPCMPESTRI / PCMPESTRI </c>
/// instruction.
...
#define sse4_cmpestrc(A, LA, B, LB, M) \
  (int)__builtin_ia32_pcmpestric128((__v16qi)(vec2di)(A), (int)(LA), \
                                    (__v16qi)(vec2di)(B), (int)(LB), \
                                    (int)(M))
...
///
/// \code
/// int sse4_cmpestro(vec2di A, int LA, vec2di B, int LB, const int M);
/// \endcode
///
/// This intrinsic corresponds to the <c> VPCMPESTRI / PCMPESTRI </c>
/// instruction.
...
///          to the size of \a A or \a B.
/// \returns Returns bit 0 of the resulting bit mask.
#define sse4_cmpestro(A, LA, B, LB, M) \
  (int)__builtin_ia32_pcmpestrio128((__v16qi)(vec2di)(A), (int)(LA), \
                                    (__v16qi)(vec2di)(B), (int)(LB), \
                                    (int)(M))
...
///
/// \code
/// int sse4_cmpestrs(vec2di A, int LA, vec2di B, int LB, const int M);
/// \endcode
///
/// This intrinsic corresponds to the <c> VPCMPESTRI / PCMPESTRI </c>
/// instruction.
...
/// \returns Returns 1 if the length of the string in \a A is less than the
///    maximum, otherwise, returns 0.
#define sse4_cmpestrs(A, LA, B, LB, M) \
  (int)__builtin_ia32_pcmpestris128((__v16qi)(vec2di)(A), (int)(LA), \
                                    (__v16qi)(vec2di)(B), (int)(LB), \
                                    (int)(M))
...
///
/// \code
/// int sse4_cmpestrz(vec2di A, int LA, vec2di B, int LB, const int M);
/// \endcode
///
...
/// \returns Returns 1 if the length of the string in \a B is less than the
///    maximum, otherwise, returns 0.
#define sse4_cmpestrz(A, LA, B, LB, M) \
  (int)__builtin_ia32_pcmpestriz128((__v16qi)(vec2di)(A), (int)(LA), \
                                    (__v16qi)(vec2di)(B), (int)(LB), \
                                    (int)(M))
...
/// \returns A 128-bit integer vector containing the comparison results.
static __inline__ vec2di __DEFAULT_FN_ATTRS
sse4_cmpgt_epi64(vec2di __V1, vec2di __V2)
{
    return (vec2di)((__v2di)__V1 > (__v2di)__V2);
}
...
sse4_crc32_u8(unsigned int __C, unsigned char __D)
{
...
///    operand \a __D.
static __inline__ unsigned int __DEFAULT_FN_ATTRS
sse4_crc32_u16(unsigned int __C, unsigned short __D)
{
...
///    operand \a __D.
static __inline__ unsigned int __DEFAULT_FN_ATTRS
sse4_crc32_u32(unsigned int __C, unsigned int __D)
{
...
sse4_crc32_u64(unsigned long long __C, unsigned long long __D)
{
...
///    source operand.
static __inline__ int __DEFAULT_FN_ATTRS
sse4_popcnt_u32(unsigned int __A)
{
...
sse4_popcnt_u64(unsigned long long __A)
{
