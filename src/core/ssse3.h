...
ssse3_abs_pi8(vec1s64 __a)
{
    return (vec1s64)__builtin_ia32_pabsb((__v8qi)__a);
}
...
ssse3_abs_epi8(vec2di __a)
{
    return (vec2di)__builtin_ia32_pabsb128((__v16qi)__a);
}
...
///    elements in the operand.
static __inline__ vec1s64 __DEFAULT_FN_ATTRS_MMX
ssse3_abs_pi16(vec1s64 __a)
{
    return (vec1s64)__builtin_ia32_pabsw((__v4hi)__a);
}
...
///    elements in the operand.
static __inline__ vec2di __DEFAULT_FN_ATTRS
ssse3_abs_epi16(vec2di __a)
{
    return (vec2di)__builtin_ia32_pabsw128((__v8hi)__a);
}
...
///    elements in the operand.
static __inline__ vec1s64 __DEFAULT_FN_ATTRS_MMX
ssse3_abs_pi32(vec1s64 __a)
{
    return (vec1s64)__builtin_ia32_pabsd((__v2si)__a);
}
...
///    elements in the operand.
static __inline__ vec2di __DEFAULT_FN_ATTRS
ssse3_abs_epi32(vec2di __a)
{
    return (vec2di)__builtin_ia32_pabsd128((__v4si)__a);
}
...
///
/// \code
/// vec2di ssse3_alignr_epi8(vec2di a, vec2di b, const int n);
/// \endcode
///
...
///    value.
#define ssse3_alignr_epi8(a, b, n) \
  (vec2di)__builtin_ia32_palignr128((__v16qi)(vec2di)(a), \
                                     (__v16qi)(vec2di)(b), (n))
...
///
/// \code
/// vec1s64 ssse3_alignr_pi8(vec1s64 a, vec1s64 b, const int n);
/// \endcode
///
/// This intrinsic corresponds to the \c PALIGNR instruction.
///
...
///    value.
#define ssse3_alignr_pi8(a, b, n) \
  (vec1s64)__builtin_ia32_palignr((__v8qi)(vec1s64)(a), (__v8qi)(vec1s64)(b), (n))
...
///    both operands.
static __inline__ vec2di __DEFAULT_FN_ATTRS
ssse3_hadd_epi16(vec2di __a, vec2di __b)
{
    return (vec2di)__builtin_ia32_phaddw128((__v8hi)__a, (__v8hi)__b);
}
...
///    both operands.
static __inline__ vec2di __DEFAULT_FN_ATTRS
ssse3_hadd_epi32(vec2di __a, vec2di __b)
{
    return (vec2di)__builtin_ia32_phaddd128((__v4si)__a, (__v4si)__b);
}
...
///    operands.
static __inline__ vec1s64 __DEFAULT_FN_ATTRS_MMX
ssse3_hadd_pi16(vec1s64 __a, vec1s64 __b)
{
    return (vec1s64)__builtin_ia32_phaddw((__v4hi)__a, (__v4hi)__b);
}
...
///    operands.
static __inline__ vec1s64 __DEFAULT_FN_ATTRS_MMX
ssse3_hadd_pi32(vec1s64 __a, vec1s64 __b)
{
    return (vec1s64)__builtin_ia32_phaddd((__v2si)__a, (__v2si)__b);
}
...
static __inline__ vec2di __DEFAULT_FN_ATTRS
ssse3_hadds_epi16(vec2di __a, vec2di __b)
{
    return (vec2di)__builtin_ia32_phaddsw128((__v8hi)__a, (__v8hi)__b);
}
...
///    sums of both operands.
static __inline__ vec1s64 __DEFAULT_FN_ATTRS_MMX
ssse3_hadds_pi16(vec1s64 __a, vec1s64 __b)
{
    return (vec1s64)__builtin_ia32_phaddsw((__v4hi)__a, (__v4hi)__b);
}
...
///    of both operands.
static __inline__ vec2di __DEFAULT_FN_ATTRS
ssse3_hsub_epi16(vec2di __a, vec2di __b)
{
    return (vec2di)__builtin_ia32_phsubw128((__v8hi)__a, (__v8hi)__b);
}
...
///    of both operands.
static __inline__ vec2di __DEFAULT_FN_ATTRS
ssse3_hsub_epi32(vec2di __a, vec2di __b)
{
    return (vec2di)__builtin_ia32_phsubd128((__v4si)__a, (__v4si)__b);
}
...
///    of both operands.
static __inline__ vec1s64 __DEFAULT_FN_ATTRS_MMX
ssse3_hsub_pi16(vec1s64 __a, vec1s64 __b)
{
    return (vec1s64)__builtin_ia32_phsubw((__v4hi)__a, (__v4hi)__b);
}
...
///    of both operands.
static __inline__ vec1s64 __DEFAULT_FN_ATTRS_MMX
ssse3_hsub_pi32(vec1s64 __a, vec1s64 __b)
{
    return (vec1s64)__builtin_ia32_phsubd((__v2si)__a, (__v2si)__b);
}
...
static __inline__ vec2di __DEFAULT_FN_ATTRS
ssse3_hsubs_epi16(vec2di __a, vec2di __b)
{
    return (vec2di)__builtin_ia32_phsubsw128((__v8hi)__a, (__v8hi)__b);
}
...
///    differences of both operands.
static __inline__ vec1s64 __DEFAULT_FN_ATTRS_MMX
ssse3_hsubs_pi16(vec1s64 __a, vec1s64 __b)
{
    return (vec1s64)__builtin_ia32_phsubsw((__v4hi)__a, (__v4hi)__b);
}
...
static __inline__ vec2di __DEFAULT_FN_ATTRS
ssse3_maddubs_epi16(vec2di __a, vec2di __b)
{
    return (vec2di)__builtin_ia32_pmaddubsw128((__v16qi)__a, (__v16qi)__b);
}
...
///    \a R3 := (\a __a6 * \a __b6) + (\a __a7 * \a __b7)
static __inline__ vec1s64 __DEFAULT_FN_ATTRS_MMX
ssse3_maddubs_pi16(vec1s64 __a, vec1s64 __b)
{
    return (vec1s64)__builtin_ia32_pmaddubsw((__v8qi)__a, (__v8qi)__b);
}
...
static __inline__ vec2di __DEFAULT_FN_ATTRS
ssse3_mulhrs_epi16(vec2di __a, vec2di __b)
{
    return (vec2di)__builtin_ia32_pmulhrsw128((__v8hi)__a, (__v8hi)__b);
}
...
///    products of both operands.
static __inline__ vec1s64 __DEFAULT_FN_ATTRS_MMX
ssse3_mulhrs_pi16(vec1s64 __a, vec1s64 __b)
{
    return (vec1s64)__builtin_ia32_pmulhrsw((__v4hi)__a, (__v4hi)__b);
}
...
static __inline__ vec2di __DEFAULT_FN_ATTRS
ssse3_shuffle_epi8(vec2di __a, vec2di __b)
{
    return (vec2di)__builtin_ia32_pshufb128((__v16qi)__a, (__v16qi)__b);
}
...
static __inline__ vec1s64 __DEFAULT_FN_ATTRS_MMX
ssse3_shuffle_pi8(vec1s64 __a, vec1s64 __b)
{
    return (vec1s64)__builtin_ia32_pshufb((__v8qi)__a, (__v8qi)__b);
}
...
static __inline__ vec2di __DEFAULT_FN_ATTRS
ssse3_sign_epi8(vec2di __a, vec2di __b)
{
    return (vec2di)__builtin_ia32_psignb128((__v16qi)__a, (__v16qi)__b);
}
...
/// \returns A 128-bit integer vector containing the resultant values.
static __inline__ vec2di __DEFAULT_FN_ATTRS
ssse3_sign_epi16(vec2di __a, vec2di __b)
{
    return (vec2di)__builtin_ia32_psignw128((__v8hi)__a, (__v8hi)__b);
}
...
/// \returns A 128-bit integer vector containing the resultant values.
static __inline__ vec2di __DEFAULT_FN_ATTRS
ssse3_sign_epi32(vec2di __a, vec2di __b)
{
    return (vec2di)__builtin_ia32_psignd128((__v4si)__a, (__v4si)__b);
}
...
static __inline__ vec1s64 __DEFAULT_FN_ATTRS_MMX
ssse3_sign_pi8(vec1s64 __a, vec1s64 __b)
{
    return (vec1s64)__builtin_ia32_psignb((__v8qi)__a, (__v8qi)__b);
}
...
/// \returns A 64-bit integer vector containing the resultant values.
static __inline__ vec1s64 __DEFAULT_FN_ATTRS_MMX
ssse3_sign_pi16(vec1s64 __a, vec1s64 __b)
{
    return (vec1s64)__builtin_ia32_psignw((__v4hi)__a, (__v4hi)__b);
}
...
/// \returns A 64-bit integer vector containing the resultant values.
static __inline__ vec1s64 __DEFAULT_FN_ATTRS_MMX
ssse3_sign_pi32(vec1s64 __a, vec1s64 __b)
{
    return (vec1s64)__builtin_ia32_psignd((__v2si)__a, (__v2si)__b);
}
