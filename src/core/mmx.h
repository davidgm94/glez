...
// __m64
typedef long long vec1s64 VECTOR_TYPE_ALIGNMENT(1, 8);

typedef long long vec1s64_unaligned VECTOR_TYPE(1);
typedef int vec2s32 VECTOR_TYPE(2);
typedef vec2s32 vec2i;
typedef short vec4s16 VECTOR_TYPE(4);
typedef char vec8s8 VECTOR_TYPE(8);
...
static __inline__ vec1s64 __DEFAULT_FN_ATTRS
mmx_cvtsi32_si64(int __i)
{
    return (vec1s64)__builtin_ia32_vec_init_v2si(__i, 0);
}
...
mmx_cvtsi64_si32(vec1s64 __m)
{
    return __builtin_ia32_vec_ext_v2si((vec2s32)__m, 0);
}
...
mmx_cvtm64_si64(vec1s64 __m)
{
    return (long long)__m[0];
}
...
///    values.
static __inline__ vec1s64 __DEFAULT_FN_ATTRS
mmx_packs_pi16(vec1s64 __m1, vec1s64 __m2)
{
    return (vec1s64)__builtin_ia32_packsswb((vec4s16)__m1, (vec4s16)__m2);
}
...
///    values.
static __inline__ vec1s64 __DEFAULT_FN_ATTRS
mmx_packs_pi32(vec1s64 __m1, vec1s64 __m2)
{
    return (vec1s64)__builtin_ia32_packssdw((vec2s32)__m1, (vec2s32)__m2);
}
...
///    values.
static __inline__ vec1s64 __DEFAULT_FN_ATTRS
mmx_packs_pu16(vec1s64 __m1, vec1s64 __m2)
{
    return (vec1s64)__builtin_ia32_packuswb((vec4s16)__m1, (vec4s16)__m2);
}
...
///    values.
static __inline__ vec1s64 __DEFAULT_FN_ATTRS
mmx_unpackhi_pi8(vec1s64 __m1, vec1s64 __m2)
{
    return (vec1s64)__builtin_ia32_punpckhbw((vec8s8)__m1, (vec8s8)__m2);
}
...
///    values.
static __inline__ vec1s64 __DEFAULT_FN_ATTRS
mmx_unpackhi_pi16(vec1s64 __m1, vec1s64 __m2)
{
    return (vec1s64)__builtin_ia32_punpckhwd((vec4s16)__m1, (vec4s16)__m2);
}
...
///    values.
static __inline__ vec1s64 __DEFAULT_FN_ATTRS
mmx_unpackhi_pi32(vec1s64 __m1, vec1s64 __m2)
{
    return (vec1s64)__builtin_ia32_punpckhdq((vec2s32)__m1, (vec2s32)__m2);
}
...
///    values.
static __inline__ vec1s64 __DEFAULT_FN_ATTRS
mmx_unpacklo_pi8(vec1s64 __m1, vec1s64 __m2)
{
    return (vec1s64)__builtin_ia32_punpcklbw((vec8s8)__m1, (vec8s8)__m2);
}
...
///    values.
static __inline__ vec1s64 __DEFAULT_FN_ATTRS
mmx_unpacklo_pi16(vec1s64 __m1, vec1s64 __m2)
{
    return (vec1s64)__builtin_ia32_punpcklwd((vec4s16)__m1, (vec4s16)__m2);
}
...
///    values.
static __inline__ vec1s64 __DEFAULT_FN_ATTRS
mmx_unpacklo_pi32(vec1s64 __m1, vec1s64 __m2)
{
    return (vec1s64)__builtin_ia32_punpckldq((vec2s32)__m1, (vec2s32)__m2);
}
...
///    parameters.
static __inline__ vec1s64 __DEFAULT_FN_ATTRS
mmx_add_pi8(vec1s64 __m1, vec1s64 __m2)
{
    return (vec1s64)__builtin_ia32_paddb((vec8s8)__m1, (vec8s8)__m2);
}
...
///    parameters.
static __inline__ vec1s64 __DEFAULT_FN_ATTRS
mmx_add_pi16(vec1s64 __m1, vec1s64 __m2)
{
    return (vec1s64)__builtin_ia32_paddw((vec4s16)__m1, (vec4s16)__m2);
}
...
///    parameters.
static __inline__ vec1s64 __DEFAULT_FN_ATTRS
mmx_add_pi32(vec1s64 __m1, vec1s64 __m2)
{
    return (vec1s64)__builtin_ia32_paddd((vec2s32)__m1, (vec2s32)__m2);
}
...
///    of both parameters.
static __inline__ vec1s64 __DEFAULT_FN_ATTRS
mmx_adds_pi8(vec1s64 __m1, vec1s64 __m2)
{
    return (vec1s64)__builtin_ia32_paddsb((vec8s8)__m1, (vec8s8)__m2);
}
...
///    of both parameters.
static __inline__ vec1s64 __DEFAULT_FN_ATTRS
mmx_adds_pi16(vec1s64 __m1, vec1s64 __m2)
{
    return (vec1s64)__builtin_ia32_paddsw((vec4s16)__m1, (vec4s16)__m2);
}
...
static __inline__ vec1s64 __DEFAULT_FN_ATTRS
mmx_adds_pu8(vec1s64 __m1, vec1s64 __m2)
{
    return (vec1s64)__builtin_ia32_paddusb((vec8s8)__m1, (vec8s8)__m2);
}
...
///    unsigned sums of both parameters.
static __inline__ vec1s64 __DEFAULT_FN_ATTRS
mmx_adds_pu16(vec1s64 __m1, vec1s64 __m2)
{
    return (vec1s64)__builtin_ia32_paddusw((vec4s16)__m1, (vec4s16)__m2);
}
...
///    both parameters.
static __inline__ vec1s64 __DEFAULT_FN_ATTRS
mmx_sub_pi8(vec1s64 __m1, vec1s64 __m2)
{
    return (vec1s64)__builtin_ia32_psubb((vec8s8)__m1, (vec8s8)__m2);
}
...
///    both parameters.
static __inline__ vec1s64 __DEFAULT_FN_ATTRS
mmx_sub_pi16(vec1s64 __m1, vec1s64 __m2)
{
    return (vec1s64)__builtin_ia32_psubw((vec4s16)__m1, (vec4s16)__m2);
}
...
///    both parameters.
static __inline__ vec1s64 __DEFAULT_FN_ATTRS
mmx_sub_pi32(vec1s64 __m1, vec1s64 __m2)
{
    return (vec1s64)__builtin_ia32_psubd((vec2s32)__m1, (vec2s32)__m2);
}
...
static __inline__ vec1s64 __DEFAULT_FN_ATTRS
mmx_subs_pi8(vec1s64 __m1, vec1s64 __m2)
{
    return (vec1s64)__builtin_ia32_psubsb((vec8s8)__m1, (vec8s8)__m2);
}
...
///    differences of both parameters.
static __inline__ vec1s64 __DEFAULT_FN_ATTRS
mmx_subs_pi16(vec1s64 __m1, vec1s64 __m2)
{
    return (vec1s64)__builtin_ia32_psubsw((vec4s16)__m1, (vec4s16)__m2);
}
...
///    differences of both parameters.
static __inline__ vec1s64 __DEFAULT_FN_ATTRS
mmx_subs_pu8(vec1s64 __m1, vec1s64 __m2)
{
    return (vec1s64)__builtin_ia32_psubusb((vec8s8)__m1, (vec8s8)__m2);
}
...
///    differences of both parameters.
static __inline__ vec1s64 __DEFAULT_FN_ATTRS
mmx_subs_pu16(vec1s64 __m1, vec1s64 __m2)
{
    return (vec1s64)__builtin_ia32_psubusw((vec4s16)__m1, (vec4s16)__m2);
}
...
static __inline__ vec1s64 __DEFAULT_FN_ATTRS
mmx_madd_pi16(vec1s64 __m1, vec1s64 __m2)
{
    return (vec1s64)__builtin_ia32_pmaddwd((vec4s16)__m1, (vec4s16)__m2);
}
...
static __inline__ vec1s64 __DEFAULT_FN_ATTRS
mmx_mulhi_pi16(vec1s64 __m1, vec1s64 __m2)
{
    return (vec1s64)__builtin_ia32_pmulhw((vec4s16)__m1, (vec4s16)__m2);
}
...
///    of the products of both parameters.
static __inline__ vec1s64 __DEFAULT_FN_ATTRS
mmx_mullo_pi16(vec1s64 __m1, vec1s64 __m2)
{
    return (vec1s64)__builtin_ia32_pmullw((vec4s16)__m1, (vec4s16)__m2);
}
...
///    0.
static __inline__ vec1s64 __DEFAULT_FN_ATTRS
mmx_sll_pi16(vec1s64 __m, vec1s64 __count)
{
    return (vec1s64)__builtin_ia32_psllw((vec4s16)__m, __count);
}
...
///    0.
static __inline__ vec1s64 __DEFAULT_FN_ATTRS
mmx_slli_pi16(vec1s64 __m, int __count)
{
    return (vec1s64)__builtin_ia32_psllwi((vec4s16)__m, __count);
}
...
///    0.
static __inline__ vec1s64 __DEFAULT_FN_ATTRS
mmx_sll_pi32(vec1s64 __m, vec1s64 __count)
{
    return (vec1s64)__builtin_ia32_pslld((vec2s32)__m, __count);
}
...
///    0.
static __inline__ vec1s64 __DEFAULT_FN_ATTRS
mmx_slli_pi32(vec1s64 __m, int __count)
{
    return (vec1s64)__builtin_ia32_pslldi((vec2s32)__m, __count);
}
...
static __inline__ vec1s64 __DEFAULT_FN_ATTRS
mmx_sll_si64(vec1s64 __m, vec1s64 __count)
{
    return (vec1s64)__builtin_ia32_psllq((vec1s64_unaligned)__m, __count);
}
...
///     \a __count is greater or equal to 64, the result is set to 0.
static __inline__ vec1s64 __DEFAULT_FN_ATTRS
mmx_slli_si64(vec1s64 __m, int __count)
{
    return (vec1s64)__builtin_ia32_psllqi((vec1s64_unaligned)__m, __count);
}
...
///    values.
static __inline__ vec1s64 __DEFAULT_FN_ATTRS
mmx_sra_pi16(vec1s64 __m, vec1s64 __count)
{
    return (vec1s64)__builtin_ia32_psraw((vec4s16)__m, __count);
}
...
///    values.
static __inline__ vec1s64 __DEFAULT_FN_ATTRS
mmx_srai_pi16(vec1s64 __m, int __count)
{
    return (vec1s64)__builtin_ia32_psrawi((vec4s16)__m, __count);
}
...
///    values.
static __inline__ vec1s64 __DEFAULT_FN_ATTRS
mmx_sra_pi32(vec1s64 __m, vec1s64 __count)
{
    return (vec1s64)__builtin_ia32_psrad((vec2s32)__m, __count);
}
...
///    values.
static __inline__ vec1s64 __DEFAULT_FN_ATTRS
mmx_srai_pi32(vec1s64 __m, int __count)
{
    return (vec1s64)__builtin_ia32_psradi((vec2s32)__m, __count);
}
...
///    values.
static __inline__ vec1s64 __DEFAULT_FN_ATTRS
mmx_srl_pi16(vec1s64 __m, vec1s64 __count)
{
    return (vec1s64)__builtin_ia32_psrlw((vec4s16)__m, __count);
}
...
///    values.
static __inline__ vec1s64 __DEFAULT_FN_ATTRS
mmx_srli_pi16(vec1s64 __m, int __count)
{
    return (vec1s64)__builtin_ia32_psrlwi((vec4s16)__m, __count);
}
...
///    values.
static __inline__ vec1s64 __DEFAULT_FN_ATTRS
mmx_srl_pi32(vec1s64 __m, vec1s64 __count)
{
    return (vec1s64)__builtin_ia32_psrld((vec2s32)__m, __count);
}
...
///    values.
static __inline__ vec1s64 __DEFAULT_FN_ATTRS
mmx_srli_pi32(vec1s64 __m, int __count)
{
    return (vec1s64)__builtin_ia32_psrldi((vec2s32)__m, __count);
}
...
static __inline__ vec1s64 __DEFAULT_FN_ATTRS
mmx_srl_si64(vec1s64 __m, vec1s64 __count)
{
    return (vec1s64)__builtin_ia32_psrlq((vec1s64_unaligned)__m, __count);
}
...
/// \returns A 64-bit integer vector containing the right-shifted value.
static __inline__ vec1s64 __DEFAULT_FN_ATTRS
mmx_srli_si64(vec1s64 __m, int __count)
{
    return (vec1s64)__builtin_ia32_psrlqi((vec1s64_unaligned)__m, __count);
}
...
///    parameters.
static __inline__ vec1s64 __DEFAULT_FN_ATTRS
mmx_and_si64(vec1s64 __m1, vec1s64 __m2)
{
    return __builtin_ia32_pand((vec1s64_unaligned)__m1, (vec1s64_unaligned)__m2);
}
...
static __inline__ vec1s64 __DEFAULT_FN_ATTRS
mmx_andnot_si64(vec1s64 __m1, vec1s64 __m2)
{
    return __builtin_ia32_pandn((vec1s64_unaligned)__m1, (vec1s64_unaligned)__m2);
}
...
///    parameters.
static __inline__ vec1s64 __DEFAULT_FN_ATTRS
mmx_or_si64(vec1s64 __m1, vec1s64 __m2)
{
    return __builtin_ia32_por((vec1s64_unaligned)__m1, (vec1s64_unaligned)__m2);
}
...
///    parameters.
static __inline__ vec1s64 __DEFAULT_FN_ATTRS
mmx_xor_si64(vec1s64 __m1, vec1s64 __m2)
{
    return __builtin_ia32_pxor((vec1s64_unaligned)__m1, (vec1s64_unaligned)__m2);
}
...
///    results.
static __inline__ vec1s64 __DEFAULT_FN_ATTRS
mmx_cmpeq_pi8(vec1s64 __m1, vec1s64 __m2)
{
    return (vec1s64)__builtin_ia32_pcmpeqb((vec8s8)__m1, (vec8s8)__m2);
}
...
///    results.
static __inline__ vec1s64 __DEFAULT_FN_ATTRS
mmx_cmpeq_pi16(vec1s64 __m1, vec1s64 __m2)
{
    return (vec1s64)__builtin_ia32_pcmpeqw((vec4s16)__m1, (vec4s16)__m2);
}
...
///    results.
static __inline__ vec1s64 __DEFAULT_FN_ATTRS
mmx_cmpeq_pi32(vec1s64 __m1, vec1s64 __m2)
{
    return (vec1s64)__builtin_ia32_pcmpeqd((vec2s32)__m1, (vec2s32)__m2);
}
...
///    results.
static __inline__ vec1s64 __DEFAULT_FN_ATTRS
mmx_cmpgt_pi8(vec1s64 __m1, vec1s64 __m2)
{
    return (vec1s64)__builtin_ia32_pcmpgtb((vec8s8)__m1, (vec8s8)__m2);
}
...
///    results.
static __inline__ vec1s64 __DEFAULT_FN_ATTRS
mmx_cmpgt_pi16(vec1s64 __m1, vec1s64 __m2)
{
    return (vec1s64)__builtin_ia32_pcmpgtw((vec4s16)__m1, (vec4s16)__m2);
}
...
///    results.
static __inline__ vec1s64 __DEFAULT_FN_ATTRS
mmx_cmpgt_pi32(vec1s64 __m1, vec1s64 __m2)
{
    return (vec1s64)__builtin_ia32_pcmpgtd((vec2s32)__m1, (vec2s32)__m2);
}
...
static __inline__ vec1s64 __DEFAULT_FN_ATTRS
mmx_setzero_si64(void)
{
    return __extension__ (vec1s64){ 0LL };
}
...
static __inline__ vec1s64 __DEFAULT_FN_ATTRS
mmx_set_pi32(int __i1, int __i0)
{
    return (vec1s64)__builtin_ia32_vec_init_v2si(__i0, __i1);
}
...
/// \returns An initialized 64-bit integer vector.
static __inline__ vec1s64 __DEFAULT_FN_ATTRS
mmx_set_pi16(short __s3, short __s2, short __s1, short __s0)
{
    return (vec1s64)__builtin_ia32_vec_init_v4hi(__s0, __s1, __s2, __s3);
}
...
/// \returns An initialized 64-bit integer vector.
static __inline__ vec1s64 __DEFAULT_FN_ATTRS
mmx_set_pi8(char __b7, char __b6, char __b5, char __b4, char __b3, char __b2,
            char __b1, char __b0)
{
    return (vec1s64)__builtin_ia32_vec_init_v8qi(__b0, __b1, __b2, __b3,
                                               __b4, __b5, __b6, __b7);
}
...
static __inline__ vec1s64 __DEFAULT_FN_ATTRS
mmx_set1_pi32(int __i)
{
    return mmx_set_pi32(__i, __i);
}
...
static __inline__ vec1s64 __DEFAULT_FN_ATTRS
mmx_set1_pi16(short __w)
{
    return mmx_set_pi16(__w, __w, __w, __w);
}
...
static __inline__ vec1s64 __DEFAULT_FN_ATTRS
mmx_set1_pi8(char __b)
{
    return mmx_set_pi8(__b, __b, __b, __b, __b, __b, __b, __b);
}
...
/// \returns An initialized 64-bit integer vector.
static __inline__ vec1s64 __DEFAULT_FN_ATTRS
mmx_setr_pi32(int __i0, int __i1)
{
    return mmx_set_pi32(__i1, __i0);
}
...
/// \returns An initialized 64-bit integer vector.
static __inline__ vec1s64 __DEFAULT_FN_ATTRS
mmx_setr_pi16(short __w0, short __w1, short __w2, short __w3)
{
    return mmx_set_pi16(__w3, __w2, __w1, __w0);
}
...
/// \returns An initialized 64-bit integer vector.
static __inline__ vec1s64 __DEFAULT_FN_ATTRS
mmx_setr_pi8(char __b0, char __b1, char __b2, char __b3, char __b4, char __b5,
             char __b6, char __b7)
{
    return mmx_set_pi8(__b7, __b6, __b5, __b4, __b3, __b2, __b1, __b0);
}
