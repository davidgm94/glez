...
#include "type.h"
#include "sse.h"
typedef double vec2f64 VECTOR_TYPE_ALIGNMENT(2, 16);
typedef vec2f64 vec2df;
typedef long long vec2s64 VECTOR_TYPE_ALIGNMENT(2, 16);
typedef vec2s64 vec2di;

typedef double vec2f64_u VECTOR_TYPE_ALIGNMENT(2, 1);
typedef vec2f64_u vec2df_u;
typedef long long vec2s64_u VECTOR_TYPE_ALIGNMENT(2, 1);
typedef vec2s64_u vec2di_u;

/* Type defines.  */
typedef double v2df VECTOR_TYPE(2);
typedef long long v2di VECTOR_TYPE(2);
typedef short v8hi VECTOR_TYPE(8);
typedef char v16qi VECTOR_TYPE(16);

/* Unsigned types */

typedef unsigned long long v2du VECTOR_TYPE(2);
typedef unsigned short v8hu VECTOR_TYPE(8);
typedef unsigned char v16qu VECTOR_TYPE(16);

/* We need an explicitly signed variant for char. Note that this shouldn't
 * appear in the interface though. */
typedef signed char v16qs VECTOR_TYPE(16);
...
sse2_add_sd(vec2df __a, vec2df __b)
{
    __a[0] += __b[0];
    return __a;
}
...
///    operands.
static __inline__ vec2df __DEFAULT_FN_ATTRS
sse2_add_pd(vec2df __a, vec2df __b)
{
    return (vec2df)((v2df)__a + (v2df)__b);
}
...
static __inline__ vec2df __DEFAULT_FN_ATTRS
sse2_sub_sd(vec2df __a, vec2df __b)
{
    __a[0] -= __b[0];
    return __a;
}
...
///    both operands.
static __inline__ vec2df __DEFAULT_FN_ATTRS
sse2_sub_pd(vec2df __a, vec2df __b)
{
    return (vec2df)((v2df)__a - (v2df)__b);
}
...
///    copied from the upper 64 bits of the first source operand.
static __inline__ vec2df __DEFAULT_FN_ATTRS
sse2_mul_sd(vec2df __a, vec2df __b)
{
    __a[0] *= __b[0];
    return __a;
}
...
///    operands.
static __inline__ vec2df __DEFAULT_FN_ATTRS
sse2_mul_pd(vec2df __a, vec2df __b)
{
    return (vec2df)((v2df)__a * (v2df)__b);
}
...
///    copied from the upper 64 bits of the first source operand.
static __inline__ vec2df __DEFAULT_FN_ATTRS
sse2_div_sd(vec2df __a, vec2df __b)
{
    __a[0] /= __b[0];
    return __a;
}
...
///    operands.
static __inline__ vec2df __DEFAULT_FN_ATTRS
sse2_div_pd(vec2df __a, vec2df __b)
{
    return (vec2df)((v2df)__a / (v2df)__b);
}
...
static __inline__ vec2df __DEFAULT_FN_ATTRS
sse2_sqrt_sd(vec2df __a, vec2df __b)
{
    vec2df __c = __builtin_ia32_sqrtsd((v2df)__b);
    return __extension__ (vec2df) { __c[0], __a[1] };
}
...
static __inline__ vec2df __DEFAULT_FN_ATTRS
sse2_sqrt_pd(vec2df __a)
{
    return __builtin_ia32_sqrtpd((v2df)__a);
}
...
static __inline__ vec2df __DEFAULT_FN_ATTRS
sse2_min_sd(vec2df __a, vec2df __b)
{
    return __builtin_ia32_minsd((v2df)__a, (v2df)__b);
}
...
static __inline__ vec2df __DEFAULT_FN_ATTRS
sse2_min_pd(vec2df __a, vec2df __b)
{
    return __builtin_ia32_minpd((v2df)__a, (v2df)__b);
}
...
///    the upper 64 bits of the first source operand.
static __inline__ vec2df __DEFAULT_FN_ATTRS
sse2_max_sd(vec2df __a, vec2df __b)
{
    return __builtin_ia32_maxsd((v2df)__a, (v2df)__b);
}
...
///    between both operands.
static __inline__ vec2df __DEFAULT_FN_ATTRS
sse2_max_pd(vec2df __a, vec2df __b)
{
    return __builtin_ia32_maxpd((v2df)__a, (v2df)__b);
}
...
static __inline__ vec2df __DEFAULT_FN_ATTRS
sse2_and_pd(vec2df __a, vec2df __b)
{
    return (vec2df)((__v2du)__a & (__v2du)__b);
}
...
///    operand.
static __inline__ vec2df __DEFAULT_FN_ATTRS
sse2_andnot_pd(vec2df __a, vec2df __b)
{
    return (vec2df)(~(__v2du)__a & (__v2du)__b);
}
...
///    values between both operands.
static __inline__ vec2df __DEFAULT_FN_ATTRS
sse2_or_pd(vec2df __a, vec2df __b)
{
    return (vec2df)((__v2du)__a | (__v2du)__b);
}
...
///    values between both operands.
static __inline__ vec2df __DEFAULT_FN_ATTRS
sse2_xor_pd(vec2df __a, vec2df __b)
{
    return (vec2df)((__v2du)__a ^ (__v2du)__b);
}
...
static __inline__ vec2df __DEFAULT_FN_ATTRS
sse2_cmpeq_pd(vec2df __a, vec2df __b)
{
    return (vec2df)__builtin_ia32_cmpeqpd((v2df)__a, (v2df)__b);
}
...
/// \returns A 128-bit vector containing the comparison results.
static __inline__ vec2df __DEFAULT_FN_ATTRS
sse2_cmplt_pd(vec2df __a, vec2df __b)
{
    return (vec2df)__builtin_ia32_cmpltpd((v2df)__a, (v2df)__b);
}
...
/// \returns A 128-bit vector containing the comparison results.
static __inline__ vec2df __DEFAULT_FN_ATTRS
sse2_cmple_pd(vec2df __a, vec2df __b)
{
    return (vec2df)__builtin_ia32_cmplepd((v2df)__a, (v2df)__b);
}
...
/// \returns A 128-bit vector containing the comparison results.
static __inline__ vec2df __DEFAULT_FN_ATTRS
sse2_cmpgt_pd(vec2df __a, vec2df __b)
{
    return (vec2df)__builtin_ia32_cmpltpd((v2df)__b, (v2df)__a);
}
...
/// \returns A 128-bit vector containing the comparison results.
static __inline__ vec2df __DEFAULT_FN_ATTRS
sse2_cmpge_pd(vec2df __a, vec2df __b)
{
    return (vec2df)__builtin_ia32_cmplepd((v2df)__b, (v2df)__a);
}
...
/// \returns A 128-bit vector containing the comparison results.
static __inline__ vec2df __DEFAULT_FN_ATTRS
sse2_cmpord_pd(vec2df __a, vec2df __b)
{
    return (vec2df)__builtin_ia32_cmpordpd((v2df)__a, (v2df)__b);
}
...
/// \returns A 128-bit vector containing the comparison results.
static __inline__ vec2df __DEFAULT_FN_ATTRS
sse2_cmpunord_pd(vec2df __a, vec2df __b)
{
    return (vec2df)__builtin_ia32_cmpunordpd((v2df)__a, (v2df)__b);
}
...
/// \returns A 128-bit vector containing the comparison results.
static __inline__ vec2df __DEFAULT_FN_ATTRS
sse2_cmpneq_pd(vec2df __a, vec2df __b)
{
    return (vec2df)__builtin_ia32_cmpneqpd((v2df)__a, (v2df)__b);
}
...
/// \returns A 128-bit vector containing the comparison results.
static __inline__ vec2df __DEFAULT_FN_ATTRS
sse2_cmpnlt_pd(vec2df __a, vec2df __b)
{
    return (vec2df)__builtin_ia32_cmpnltpd((v2df)__a, (v2df)__b);
}
...
/// \returns A 128-bit vector containing the comparison results.
static __inline__ vec2df __DEFAULT_FN_ATTRS
sse2_cmpnle_pd(vec2df __a, vec2df __b)
{
    return (vec2df)__builtin_ia32_cmpnlepd((v2df)__a, (v2df)__b);
}
...
/// \returns A 128-bit vector containing the comparison results.
static __inline__ vec2df __DEFAULT_FN_ATTRS
sse2_cmpngt_pd(vec2df __a, vec2df __b)
{
    return (vec2df)__builtin_ia32_cmpnltpd((v2df)__b, (v2df)__a);
}
...
/// \returns A 128-bit vector containing the comparison results.
static __inline__ vec2df __DEFAULT_FN_ATTRS
sse2_cmpnge_pd(vec2df __a, vec2df __b)
{
    return (vec2df)__builtin_ia32_cmpnlepd((v2df)__b, (v2df)__a);
}
...
static __inline__ vec2df __DEFAULT_FN_ATTRS
sse2_cmpeq_sd(vec2df __a, vec2df __b)
{
    return (vec2df)__builtin_ia32_cmpeqsd((v2df)__a, (v2df)__b);
}
...
///    results. The upper 64 bits are copied from the upper 64 bits of \a __a.
static __inline__ vec2df __DEFAULT_FN_ATTRS
sse2_cmplt_sd(vec2df __a, vec2df __b)
{
    return (vec2df)__builtin_ia32_cmpltsd((v2df)__a, (v2df)__b);
}
...
///    results. The upper 64 bits are copied from the upper 64 bits of \a __a.
static __inline__ vec2df __DEFAULT_FN_ATTRS
sse2_cmple_sd(vec2df __a, vec2df __b)
{
    return (vec2df)__builtin_ia32_cmplesd((v2df)__a, (v2df)__b);
}
...
///     results. The upper 64 bits are copied from the upper 64 bits of \a __a.
static __inline__ vec2df __DEFAULT_FN_ATTRS
sse2_cmpgt_sd(vec2df __a, vec2df __b)
{
    vec2df __c = __builtin_ia32_cmpltsd((v2df)__b, (v2df)__a);
    return __extension__ (vec2df) { __c[0], __a[1] };
}
...
///    results. The upper 64 bits are copied from the upper 64 bits of \a __a.
static __inline__ vec2df __DEFAULT_FN_ATTRS
sse2_cmpge_sd(vec2df __a, vec2df __b)
{
    vec2df __c = __builtin_ia32_cmplesd((v2df)__b, (v2df)__a);
    return __extension__ (vec2df) { __c[0], __a[1] };
}
...
///    results. The upper 64 bits are copied from the upper 64 bits of \a __a.
static __inline__ vec2df __DEFAULT_FN_ATTRS
sse2_cmpord_sd(vec2df __a, vec2df __b)
{
    return (vec2df)__builtin_ia32_cmpordsd((v2df)__a, (v2df)__b);
}
...
///    results. The upper 64 bits are copied from the upper 64 bits of \a __a.
static __inline__ vec2df __DEFAULT_FN_ATTRS
sse2_cmpunord_sd(vec2df __a, vec2df __b)
{
    return (vec2df)__builtin_ia32_cmpunordsd((v2df)__a, (v2df)__b);
}
...
///    results. The upper 64 bits are copied from the upper 64 bits of \a __a.
static __inline__ vec2df __DEFAULT_FN_ATTRS
sse2_cmpneq_sd(vec2df __a, vec2df __b)
{
    return (vec2df)__builtin_ia32_cmpneqsd((v2df)__a, (v2df)__b);
}
...
///    results. The upper 64 bits are copied from the upper 64 bits of \a __a.
static __inline__ vec2df __DEFAULT_FN_ATTRS
sse2_cmpnlt_sd(vec2df __a, vec2df __b)
{
    return (vec2df)__builtin_ia32_cmpnltsd((v2df)__a, (v2df)__b);
}
...
///    results. The upper 64 bits are copied from the upper 64 bits of \a __a.
static __inline__ vec2df __DEFAULT_FN_ATTRS
sse2_cmpnle_sd(vec2df __a, vec2df __b)
{
    return (vec2df)__builtin_ia32_cmpnlesd((v2df)__a, (v2df)__b);
}
...
///    results. The upper 64 bits are copied from the upper 64 bits of \a __a.
static __inline__ vec2df __DEFAULT_FN_ATTRS
sse2_cmpngt_sd(vec2df __a, vec2df __b)
{
    vec2df __c = __builtin_ia32_cmpnltsd((v2df)__b, (v2df)__a);
    return __extension__ (vec2df) { __c[0], __a[1] };
}
...
///    results. The upper 64 bits are copied from the upper 64 bits of \a __a.
static __inline__ vec2df __DEFAULT_FN_ATTRS
sse2_cmpnge_sd(vec2df __a, vec2df __b)
{
    vec2df __c = __builtin_ia32_cmpnlesd((v2df)__b, (v2df)__a);
    return __extension__ (vec2df) { __c[0], __a[1] };
}
...
sse2_comieq_sd(vec2df __a, vec2df __b)
{
    return __builtin_ia32_comisdeq((v2df)__a, (v2df)__b);
}
...
///     lower double-precision values is NaN, 0 is returned.
static __inline__ int __DEFAULT_FN_ATTRS
sse2_comilt_sd(vec2df __a, vec2df __b)
{
    return __builtin_ia32_comisdlt((v2df)__a, (v2df)__b);
}
...
///     lower double-precision values is NaN, 0 is returned.
static __inline__ int __DEFAULT_FN_ATTRS
sse2_comile_sd(vec2df __a, vec2df __b)
{
    return __builtin_ia32_comisdle((v2df)__a, (v2df)__b);
}
...
///     lower double-precision values is NaN, 0 is returned.
static __inline__ int __DEFAULT_FN_ATTRS
sse2_comigt_sd(vec2df __a, vec2df __b)
{
    return __builtin_ia32_comisdgt((v2df)__a, (v2df)__b);
}
...
///    lower double-precision values is NaN, 0 is returned.
static __inline__ int __DEFAULT_FN_ATTRS
sse2_comige_sd(vec2df __a, vec2df __b)
{
    return __builtin_ia32_comisdge((v2df)__a, (v2df)__b);
}
...
///     lower double-precision values is NaN, 1 is returned.
static __inline__ int __DEFAULT_FN_ATTRS
sse2_comineq_sd(vec2df __a, vec2df __b)
{
    return __builtin_ia32_comisdneq((v2df)__a, (v2df)__b);
}
...
///    lower double-precision values is NaN, 0 is returned.
static __inline__ int __DEFAULT_FN_ATTRS
sse2_ucomieq_sd(vec2df __a, vec2df __b)
{
    return __builtin_ia32_ucomisdeq((v2df)__a, (v2df)__b);
}
...
///    lower double-precision values is NaN, 0 is returned.
static __inline__ int __DEFAULT_FN_ATTRS
sse2_ucomilt_sd(vec2df __a, vec2df __b)
{
    return __builtin_ia32_ucomisdlt((v2df)__a, (v2df)__b);
}
...
///     lower double-precision values is NaN, 0 is returned.
static __inline__ int __DEFAULT_FN_ATTRS
sse2_ucomile_sd(vec2df __a, vec2df __b)
{
    return __builtin_ia32_ucomisdle((v2df)__a, (v2df)__b);
}
...
///     lower double-precision values is NaN, 0 is returned.
static __inline__ int __DEFAULT_FN_ATTRS
sse2_ucomigt_sd(vec2df __a, vec2df __b)
{
    return __builtin_ia32_ucomisdgt((v2df)__a, (v2df)__b);
}
...
///    lower double-precision values is NaN, 0 is returned.
static __inline__ int __DEFAULT_FN_ATTRS
sse2_ucomige_sd(vec2df __a, vec2df __b)
{
    return __builtin_ia32_ucomisdge((v2df)__a, (v2df)__b);
}
...
///    lower double-precision values is NaN, 1 is returned.
static __inline__ int __DEFAULT_FN_ATTRS
sse2_ucomineq_sd(vec2df __a, vec2df __b)
{
    return __builtin_ia32_ucomisdneq((v2df)__a, (v2df)__b);
}
...
sse2_cvtpd_ps(vec2df __a)
{
    return __builtin_ia32_cvtpd2ps((v2df)__a);
}
...
static __inline__ vec2df __DEFAULT_FN_ATTRS
sse2_cvtps_pd(__m128 __a)
{
    return (vec2df) __builtin_convertvector(
            __builtin_shufflevector((__v4sf)__a, (__v4sf)__a, 0, 1), v2df);
}
...
/// \returns A 128-bit vector of [2 x double] containing the converted values.
static __inline__ vec2df __DEFAULT_FN_ATTRS
sse2_cvtepi32_pd(vec2di __a)
{
    return (vec2df) __builtin_convertvector(
            __builtin_shufflevector((__v4si)__a, (__v4si)__a, 0, 1), v2df);
}
...
sse2_cvtpd_epi32(vec2df __a)
{
    return __builtin_ia32_cvtpd2dq((v2df)__a);
}
...
static __inline__ int __DEFAULT_FN_ATTRS
sse2_cvtsd_si32(vec2df __a)
{
    return __builtin_ia32_cvtsd2si((v2df)__a);
}
...
static __inline__ __m128 __DEFAULT_FN_ATTRS
sse2_cvtsd_ss(__m128 __a, vec2df __b)
{
    return (__m128)__builtin_ia32_cvtsd2ss((__v4sf)__a, (v2df)__b);
}
...
static __inline__ vec2df __DEFAULT_FN_ATTRS
sse2_cvtsi32_sd(vec2df __a, int __b)
{
    __a[0] = __b;
    return __a;
}
...
///    from the upper 64 bits of the first parameter.
static __inline__ vec2df __DEFAULT_FN_ATTRS
sse2_cvtss_sd(vec2df __a, __m128 __b)
{
    __a[0] = __b[0];
    return __a;
}
...
///    converted values. The upper 64 bits are set to zero.
static __inline__ vec2di __DEFAULT_FN_ATTRS
sse2_cvttpd_epi32(vec2df __a)
{
    return (vec2di)__builtin_ia32_cvttpd2dq((v2df)__a);
}
...
/// \returns A 32-bit signed integer containing the converted value.
static __inline__ int __DEFAULT_FN_ATTRS
sse2_cvttsd_si32(vec2df __a)
{
    return __builtin_ia32_cvttsd2si((v2df)__a);
}
...
sse2_cvtpd_pi32(vec2df __a)
{
    return (__m64)__builtin_ia32_cvtpd2pi((v2df)__a);
}
...
/// \returns A 64-bit vector of [2 x i32] containing the converted values.
static __inline__ __m64 __DEFAULT_FN_ATTRS_MMX
sse2_cvttpd_pi32(vec2df __a)
{
    return (__m64)__builtin_ia32_cvttpd2pi((v2df)__a);
}
...
/// \returns A 128-bit vector of [2 x double] containing the converted values.
static __inline__ vec2df __DEFAULT_FN_ATTRS_MMX
sse2_cvtpi32_pd(__m64 __a)
{
...
static __inline__ vec2df __DEFAULT_FN_ATTRS
sse2_load_pd(double const *__dp)
{
    return *(vec2df*)__dp;
}
...
///    duplicated values.
static __inline__ vec2df __DEFAULT_FN_ATTRS
sse2_load1_pd(double const *__dp)
{
    struct _sse2_load1_pd_struct {
        double __u;
    } __attribute__((__packed__, __may_alias__));
    double __u = ((struct _sse2_load1_pd_struct*)__dp)->__u;
    return __extension__ (vec2df){ __u, __u };
}

#define        sse2_load_pd1(dp)        sse2_load1_pd(dp)
...
///    values.
static __inline__ vec2df __DEFAULT_FN_ATTRS
sse2_loadr_pd(double const *__dp)
{
    vec2df __u = *(vec2df*)__dp;
    return __builtin_shufflevector((v2df)__u, (v2df)__u, 1, 0);
}
...
/// \returns A 128-bit vector of [2 x double] containing the loaded values.
static __inline__ vec2df __DEFAULT_FN_ATTRS
sse2_loadu_pd(double const *__dp)
{
    struct __loadu_pd {
        vec2df_u __v;
    } __attribute__((__packed__, __may_alias__));
...
static __inline__ vec2di __DEFAULT_FN_ATTRS
sse2_loadu_si64(void const *__a)
{
    struct __loadu_si64 {
        long long __v;
    } __attribute__((__packed__, __may_alias__));
    long long __u = ((struct __loadu_si64*)__a)->__v;
    return __extension__ (vec2di)(__v2di){__u, 0LL};
}
...
static __inline__ vec2di __DEFAULT_FN_ATTRS
sse2_loadu_si32(void const *__a)
{
    struct __loadu_si32 {
        int __v;
    } __attribute__((__packed__, __may_alias__));
    int __u = ((struct __loadu_si32*)__a)->__v;
    return __extension__ (vec2di)(__v4si){__u, 0, 0, 0};
}
...
static __inline__ vec2di __DEFAULT_FN_ATTRS
sse2_loadu_si16(void const *__a)
{
    struct __loadu_si16 {
        short __v;
    } __attribute__((__packed__, __may_alias__));
    short __u = ((struct __loadu_si16*)__a)->__v;
    return __extension__ (vec2di)(__v8hi){__u, 0, 0, 0, 0, 0, 0, 0};
}
...
static __inline__ vec2df __DEFAULT_FN_ATTRS
sse2_load_sd(double const *__dp)
{
    struct _sse2_load_sd_struct {
        double __u;
    } __attribute__((__packed__, __may_alias__));
    double __u = ((struct _sse2_load_sd_struct*)__dp)->__u;
    return __extension__ (vec2df){ __u, 0 };
}
...
static __inline__ vec2df __DEFAULT_FN_ATTRS
sse2_loadh_pd(vec2df __a, double const *__dp)
{
    struct _sse2_loadh_pd_struct {
        double __u;
    } __attribute__((__packed__, __may_alias__));
    double __u = ((struct _sse2_loadh_pd_struct*)__dp)->__u;
    return __extension__ (vec2df){ __a[0], __u };
}
...
/// \returns A 128-bit vector of [2 x double] containing the moved values.
static __inline__ vec2df __DEFAULT_FN_ATTRS
sse2_loadl_pd(vec2df __a, double const *__dp)
{
    struct _sse2_loadl_pd_struct {
        double __u;
    } __attribute__((__packed__, __may_alias__));
    double __u = ((struct _sse2_loadl_pd_struct*)__dp)->__u;
    return __extension__ (vec2df){ __u, __a[1] };
}
...
///    content.
static __inline__ vec2df __DEFAULT_FN_ATTRS
sse2_undefined_pd(void)
{
    return (vec2df)__builtin_ia32_undef128();
}
...
///    set to zero.
static __inline__ vec2df __DEFAULT_FN_ATTRS
sse2_set_sd(double __w)
{
    return __extension__ (vec2df){ __w, 0 };
}
...
static __inline__ vec2df __DEFAULT_FN_ATTRS
sse2_set1_pd(double __w)
{
    return __extension__ (vec2df){ __w, __w };
}
...
/// \returns An initialized 128-bit floating-point vector of [2 x double].
static __inline__ vec2df __DEFAULT_FN_ATTRS
sse2_set_pd1(double __w)
{
    return sse2_set1_pd(__w);
}
...
/// \returns An initialized 128-bit floating-point vector of [2 x double].
static __inline__ vec2df __DEFAULT_FN_ATTRS
sse2_set_pd(double __w, double __x)
{
    return __extension__ (vec2df){ __x, __w };
}
...
/// \returns An initialized 128-bit floating-point vector of [2 x double].
static __inline__ vec2df __DEFAULT_FN_ATTRS
sse2_setr_pd(double __w, double __x)
{
    return __extension__ (vec2df){ __w, __x };
}
...
static __inline__ vec2df __DEFAULT_FN_ATTRS
sse2_setzero_pd(void)
{
    return __extension__ (vec2df){ 0, 0 };
}
...
/// \returns A 128-bit vector of [2 x double] containing the moved values.
static __inline__ vec2df __DEFAULT_FN_ATTRS
sse2_move_sd(vec2df __a, vec2df __b)
{
    __a[0] = __b[0];
    return __a;
}
...
sse2_store_sd(double *__dp, vec2df __a)
{
    struct _sse2_store_sd_struct {
        double __u;
    } __attribute__((__packed__, __may_alias__));
    ((struct _sse2_store_sd_struct*)__dp)->__u = __a[0];
}
...
///    moved.
static __inline__ void __DEFAULT_FN_ATTRS
sse2_store_pd(double *__dp, vec2df __a)
{
    *(vec2df*)__dp = __a;
}
...
static __inline__ void __DEFAULT_FN_ATTRS
sse2_store1_pd(double *__dp, vec2df __a)
{
    __a = __builtin_shufflevector((v2df)__a, (v2df)__a, 0, 0);
    sse2_store_pd(__dp, __a);
}
...
///    of the values in \a __dp.
static __inline__ void __DEFAULT_FN_ATTRS
sse2_store_pd1(double *__dp, vec2df __a)
{
    sse2_store1_pd(__dp, __a);
}
...
static __inline__ void __DEFAULT_FN_ATTRS
sse2_storeu_pd(double *__dp, vec2df __a)
{
    struct __storeu_pd {
        vec2df_u __v;
    } __attribute__((__packed__, __may_alias__));
...
///    stored.
static __inline__ void __DEFAULT_FN_ATTRS
sse2_storer_pd(double *__dp, vec2df __a)
{
    __a = __builtin_shufflevector((v2df)__a, (v2df)__a, 1, 0);
    *(vec2df *)__dp = __a;
}
...
///    A 128-bit vector of [2 x double] containing the value to be stored.
static __inline__ void __DEFAULT_FN_ATTRS
sse2_storeh_pd(double *__dp, vec2df __a)
{
    struct _sse2_storeh_pd_struct {
        double __u;
    } __attribute__((__packed__, __may_alias__));
    ((struct _sse2_storeh_pd_struct*)__dp)->__u = __a[1];
}
...
///    A 128-bit vector of [2 x double] containing the value to be stored.
static __inline__ void __DEFAULT_FN_ATTRS
sse2_storel_pd(double *__dp, vec2df __a)
{
    struct _sse2_storeh_pd_struct {
        double __u;
    } __attribute__((__packed__, __may_alias__));
    ((struct _sse2_storeh_pd_struct*)__dp)->__u = __a[0];
}
...
///    parameters.
static __inline__ vec2di __DEFAULT_FN_ATTRS
sse2_add_epi8(vec2di __a, vec2di __b)
{
    return (vec2di)((__v16qu)__a + (__v16qu)__b);
}
...
///    parameters.
static __inline__ vec2di __DEFAULT_FN_ATTRS
sse2_add_epi16(vec2di __a, vec2di __b)
{
    return (vec2di)((__v8hu)__a + (__v8hu)__b);
}
...
///    parameters.
static __inline__ vec2di __DEFAULT_FN_ATTRS
sse2_add_epi32(vec2di __a, vec2di __b)
{
    return (vec2di)((__v4su)__a + (__v4su)__b);
}
...
static __inline__ __m64 __DEFAULT_FN_ATTRS_MMX
sse2_add_si64(__m64 __a, __m64 __b)
{
...
///    parameters.
static __inline__ vec2di __DEFAULT_FN_ATTRS
sse2_add_epi64(vec2di __a, vec2di __b)
{
    return (vec2di)((__v2du)__a + (__v2du)__b);
}
...
///    both parameters.
static __inline__ vec2di __DEFAULT_FN_ATTRS
sse2_adds_epi8(vec2di __a, vec2di __b)
{
    return (vec2di)__builtin_ia32_paddsb128((__v16qi)__a, (__v16qi)__b);
}
...
///    both parameters.
static __inline__ vec2di __DEFAULT_FN_ATTRS
sse2_adds_epi16(vec2di __a, vec2di __b)
{
    return (vec2di)__builtin_ia32_paddsw128((__v8hi)__a, (__v8hi)__b);
}
...
///    of both parameters.
static __inline__ vec2di __DEFAULT_FN_ATTRS
sse2_adds_epu8(vec2di __a, vec2di __b)
{
    return (vec2di)__builtin_ia32_paddusb128((__v16qi)__a, (__v16qi)__b);
}
...
///    of both parameters.
static __inline__ vec2di __DEFAULT_FN_ATTRS
sse2_adds_epu16(vec2di __a, vec2di __b)
{
    return (vec2di)__builtin_ia32_paddusw128((__v8hi)__a, (__v8hi)__b);
}
...
static __inline__ vec2di __DEFAULT_FN_ATTRS
sse2_avg_epu8(vec2di __a, vec2di __b)
{
    return (vec2di)__builtin_ia32_pavgb128((__v16qi)__a, (__v16qi)__b);
}
...
///    averages of both parameters.
static __inline__ vec2di __DEFAULT_FN_ATTRS
sse2_avg_epu16(vec2di __a, vec2di __b)
{
    return (vec2di)__builtin_ia32_pavgw128((__v8hi)__a, (__v8hi)__b);
}
...
///    of both parameters.
static __inline__ vec2di __DEFAULT_FN_ATTRS
sse2_madd_epi16(vec2di __a, vec2di __b)
{
    return (vec2di)__builtin_ia32_pmaddwd128((__v8hi)__a, (__v8hi)__b);
}
...
///    each comparison.
static __inline__ vec2di __DEFAULT_FN_ATTRS
sse2_max_epi16(vec2di __a, vec2di __b)
{
    return (vec2di)__builtin_ia32_pmaxsw128((__v8hi)__a, (__v8hi)__b);
}
...
///    each comparison.
static __inline__ vec2di __DEFAULT_FN_ATTRS
sse2_max_epu8(vec2di __a, vec2di __b)
{
    return (vec2di)__builtin_ia32_pmaxub128((__v16qi)__a, (__v16qi)__b);
}
...
///    each comparison.
static __inline__ vec2di __DEFAULT_FN_ATTRS
sse2_min_epi16(vec2di __a, vec2di __b)
{
    return (vec2di)__builtin_ia32_pminsw128((__v8hi)__a, (__v8hi)__b);
}
...
///    each comparison.
static __inline__ vec2di __DEFAULT_FN_ATTRS
sse2_min_epu8(vec2di __a, vec2di __b)
{
    return (vec2di)__builtin_ia32_pminub128((__v16qi)__a, (__v16qi)__b);
}
...
static __inline__ vec2di __DEFAULT_FN_ATTRS
sse2_mulhi_epi16(vec2di __a, vec2di __b)
{
    return (vec2di)__builtin_ia32_pmulhw128((__v8hi)__a, (__v8hi)__b);
}
...
static __inline__ vec2di __DEFAULT_FN_ATTRS
sse2_mulhi_epu16(vec2di __a, vec2di __b)
{
    return (vec2di)__builtin_ia32_pmulhuw128((__v8hi)__a, (__v8hi)__b);
}
...
///    each of the eight 32-bit products.
static __inline__ vec2di __DEFAULT_FN_ATTRS
sse2_mullo_epi16(vec2di __a, vec2di __b)
{
    return (vec2di)((__v8hu)__a * (__v8hu)__b);
}
...
static __inline__ __m64 __DEFAULT_FN_ATTRS_MMX
sse2_mul_su32(__m64 __a, __m64 __b)
{
...
static __inline__ vec2di __DEFAULT_FN_ATTRS
sse2_mul_epu32(vec2di __a, vec2di __b)
{
...
static __inline__ vec2di __DEFAULT_FN_ATTRS
sse2_sad_epu8(vec2di __a, vec2di __b)
{
...
///    in the operands.
static __inline__ vec2di __DEFAULT_FN_ATTRS
sse2_sub_epi8(vec2di __a, vec2di __b)
{
    return (vec2di)((__v16qu)__a - (__v16qu)__b);
}
...
///    in the operands.
static __inline__ vec2di __DEFAULT_FN_ATTRS
sse2_sub_epi16(vec2di __a, vec2di __b)
{
    return (vec2di)((__v8hu)__a - (__v8hu)__b);
}
...
///    in the operands.
static __inline__ vec2di __DEFAULT_FN_ATTRS
sse2_sub_epi32(vec2di __a, vec2di __b)
{
    return (vec2di)((__v4su)__a - (__v4su)__b);
}
...
///    the operands.
static __inline__ __m64 __DEFAULT_FN_ATTRS_MMX
sse2_sub_si64(__m64 __a, __m64 __b)
{
...
///    in the operands.
static __inline__ vec2di __DEFAULT_FN_ATTRS
sse2_sub_epi64(vec2di __a, vec2di __b)
{
    return (vec2di)((__v2du)__a - (__v2du)__b);
}
...
///    in the operands.
static __inline__ vec2di __DEFAULT_FN_ATTRS
sse2_subs_epi8(vec2di __a, vec2di __b)
{
    return (vec2di)__builtin_ia32_psubsb128((__v16qi)__a, (__v16qi)__b);
}
...
///    in the operands.
static __inline__ vec2di __DEFAULT_FN_ATTRS
sse2_subs_epi16(vec2di __a, vec2di __b)
{
    return (vec2di)__builtin_ia32_psubsw128((__v8hi)__a, (__v8hi)__b);
}
...
static __inline__ vec2di __DEFAULT_FN_ATTRS
sse2_subs_epu8(vec2di __a, vec2di __b)
{
    return (vec2di)__builtin_ia32_psubusb128((__v16qi)__a, (__v16qi)__b);
}
...
///    differences of the values in the operands.
static __inline__ vec2di __DEFAULT_FN_ATTRS
sse2_subs_epu16(vec2di __a, vec2di __b)
{
    return (vec2di)__builtin_ia32_psubusw128((__v8hi)__a, (__v8hi)__b);
}
...
///    in both operands.
static __inline__ vec2di __DEFAULT_FN_ATTRS
sse2_and_si128(vec2di __a, vec2di __b)
{
    return (vec2di)((__v2du)__a & (__v2du)__b);
}
...
static __inline__ vec2di __DEFAULT_FN_ATTRS
sse2_andnot_si128(vec2di __a, vec2di __b)
{
    return (vec2di)(~(__v2du)__a & (__v2du)__b);
}
...
///    in both operands.
static __inline__ vec2di __DEFAULT_FN_ATTRS
sse2_or_si128(vec2di __a, vec2di __b)
{
    return (vec2di)((__v2du)__a | (__v2du)__b);
}
...
static __inline__ vec2di __DEFAULT_FN_ATTRS
sse2_xor_si128(vec2di __a, vec2di __b)
{
    return (vec2di)((__v2du)__a ^ (__v2du)__b);
}
...
///
/// \code
/// vec2di sse2_slli_si128(vec2di a, const int imm);
/// \endcode
///
...
#define sse2_slli_si128(a, imm) \
  (vec2di)__builtin_ia32_pslldqi128_byteshift((__v2di)(vec2di)(a), (int)(imm))

#define sse2_bslli_si128(a, imm) \
  (vec2di)__builtin_ia32_pslldqi128_byteshift((__v2di)(vec2di)(a), (int)(imm))
...
static __inline__ vec2di __DEFAULT_FN_ATTRS
sse2_slli_epi16(vec2di __a, int __count)
{
    return (vec2di)__builtin_ia32_psllwi128((__v8hi)__a, __count);
}
...
/// \returns A 128-bit integer vector containing the left-shifted values.
static __inline__ vec2di __DEFAULT_FN_ATTRS
sse2_sll_epi16(vec2di __a, vec2di __count)
{
    return (vec2di)__builtin_ia32_psllw128((__v8hi)__a, (__v8hi)__count);
}
...
/// \returns A 128-bit integer vector containing the left-shifted values.
static __inline__ vec2di __DEFAULT_FN_ATTRS
sse2_slli_epi32(vec2di __a, int __count)
{
    return (vec2di)__builtin_ia32_pslldi128((__v4si)__a, __count);
}
...
/// \returns A 128-bit integer vector containing the left-shifted values.
static __inline__ vec2di __DEFAULT_FN_ATTRS
sse2_sll_epi32(vec2di __a, vec2di __count)
{
    return (vec2di)__builtin_ia32_pslld128((__v4si)__a, (__v4si)__count);
}
...
/// \returns A 128-bit integer vector containing the left-shifted values.
static __inline__ vec2di __DEFAULT_FN_ATTRS
sse2_slli_epi64(vec2di __a, int __count)
{
...
/// \returns A 128-bit integer vector containing the left-shifted values.
static __inline__ vec2di __DEFAULT_FN_ATTRS
sse2_sll_epi64(vec2di __a, vec2di __count)
{
...
static __inline__ vec2di __DEFAULT_FN_ATTRS
sse2_srai_epi16(vec2di __a, int __count)
{
    return (vec2di)__builtin_ia32_psrawi128((__v8hi)__a, __count);
}
...
/// \returns A 128-bit integer vector containing the right-shifted values.
static __inline__ vec2di __DEFAULT_FN_ATTRS
sse2_sra_epi16(vec2di __a, vec2di __count)
{
    return (vec2di)__builtin_ia32_psraw128((__v8hi)__a, (__v8hi)__count);
}
...
/// \returns A 128-bit integer vector containing the right-shifted values.
static __inline__ vec2di __DEFAULT_FN_ATTRS
sse2_srai_epi32(vec2di __a, int __count)
{
    return (vec2di)__builtin_ia32_psradi128((__v4si)__a, __count);
}
...
/// \returns A 128-bit integer vector containing the right-shifted values.
static __inline__ vec2di __DEFAULT_FN_ATTRS
sse2_sra_epi32(vec2di __a, vec2di __count)
{
    return (vec2di)__builtin_ia32_psrad128((__v4si)__a, (__v4si)__count);
}
...
///
/// \code
/// vec2di sse2_srli_si128(vec2di a, const int imm);
/// \endcode
///
...
#define sse2_srli_si128(a, imm) \
  (vec2di)__builtin_ia32_psrldqi128_byteshift((__v2di)(vec2di)(a), (int)(imm))

#define sse2_bsrli_si128(a, imm) \
  (vec2di)__builtin_ia32_psrldqi128_byteshift((__v2di)(vec2di)(a), (int)(imm))
...
/// \returns A 128-bit integer vector containing the right-shifted values.
static __inline__ vec2di __DEFAULT_FN_ATTRS
sse2_srli_epi16(vec2di __a, int __count)
{
    return (vec2di)__builtin_ia32_psrlwi128((__v8hi)__a, __count);
}
...
/// \returns A 128-bit integer vector containing the right-shifted values.
static __inline__ vec2di __DEFAULT_FN_ATTRS
sse2_srl_epi16(vec2di __a, vec2di __count)
{
    return (vec2di)__builtin_ia32_psrlw128((__v8hi)__a, (__v8hi)__count);
}
...
/// \returns A 128-bit integer vector containing the right-shifted values.
static __inline__ vec2di __DEFAULT_FN_ATTRS
sse2_srli_epi32(vec2di __a, int __count)
{
    return (vec2di)__builtin_ia32_psrldi128((__v4si)__a, __count);
}
...
/// \returns A 128-bit integer vector containing the right-shifted values.
static __inline__ vec2di __DEFAULT_FN_ATTRS
sse2_srl_epi32(vec2di __a, vec2di __count)
{
    return (vec2di)__builtin_ia32_psrld128((__v4si)__a, (__v4si)__count);
}
...
/// \returns A 128-bit integer vector containing the right-shifted values.
static __inline__ vec2di __DEFAULT_FN_ATTRS
sse2_srli_epi64(vec2di __a, int __count)
{
...
/// \returns A 128-bit integer vector containing the right-shifted values.
static __inline__ vec2di __DEFAULT_FN_ATTRS
sse2_srl_epi64(vec2di __a, vec2di __count)
{
...
static __inline__ vec2di __DEFAULT_FN_ATTRS
sse2_cmpeq_epi8(vec2di __a, vec2di __b)
{
    return (vec2di)((__v16qi)__a == (__v16qi)__b);
}
...
/// \returns A 128-bit integer vector containing the comparison results.
static __inline__ vec2di __DEFAULT_FN_ATTRS
sse2_cmpeq_epi16(vec2di __a, vec2di __b)
{
    return (vec2di)((__v8hi)__a == (__v8hi)__b);
}
...
/// \returns A 128-bit integer vector containing the comparison results.
static __inline__ vec2di __DEFAULT_FN_ATTRS
sse2_cmpeq_epi32(vec2di __a, vec2di __b)
{
    return (vec2di)((__v4si)__a == (__v4si)__b);
}
...
/// \returns A 128-bit integer vector containing the comparison results.
static __inline__ vec2di __DEFAULT_FN_ATTRS
sse2_cmpgt_epi8(vec2di __a, vec2di __b)
{
    /* This function always performs a signed comparison, but __v16qi is a char
       which may be signed or unsigned, so use __v16qs. */
    return (vec2di)((__v16qs)__a > (__v16qs)__b);
}
...
/// \returns A 128-bit integer vector containing the comparison results.
static __inline__ vec2di __DEFAULT_FN_ATTRS
sse2_cmpgt_epi16(vec2di __a, vec2di __b)
{
    return (vec2di)((__v8hi)__a > (__v8hi)__b);
}
...
/// \returns A 128-bit integer vector containing the comparison results.
static __inline__ vec2di __DEFAULT_FN_ATTRS
sse2_cmpgt_epi32(vec2di __a, vec2di __b)
{
    return (vec2di)((__v4si)__a > (__v4si)__b);
}
...
/// \returns A 128-bit integer vector containing the comparison results.
static __inline__ vec2di __DEFAULT_FN_ATTRS
sse2_cmplt_epi8(vec2di __a, vec2di __b)
{
    return sse2_cmpgt_epi8(__b, __a);
}
...
/// \returns A 128-bit integer vector containing the comparison results.
static __inline__ vec2di __DEFAULT_FN_ATTRS
sse2_cmplt_epi16(vec2di __a, vec2di __b)
{
    return sse2_cmpgt_epi16(__b, __a);
}
...
/// \returns A 128-bit integer vector containing the comparison results.
static __inline__ vec2di __DEFAULT_FN_ATTRS
sse2_cmplt_epi32(vec2di __a, vec2di __b)
{
    return sse2_cmpgt_epi32(__b, __a);
}
...
static __inline__ vec2df __DEFAULT_FN_ATTRS
sse2_cvtsi64_sd(vec2df __a, long long __b)
{
    __a[0] = __b;
    return __a;
}
...
sse2_cvtsd_si64(vec2df __a)
{
    return __builtin_ia32_cvtsd2si64((v2df)__a);
}
...
/// \returns A 64-bit signed integer containing the converted value.
static __inline__ long long __DEFAULT_FN_ATTRS
sse2_cvttsd_si64(vec2df __a)
{
    return __builtin_ia32_cvttsd2si64((v2df)__a);
}
#endif
...
///    values.
static __inline__ vec2di __DEFAULT_FN_ATTRS
sse2_cvtps_epi32(__m128 __a)
{
    return (vec2di)__builtin_ia32_cvtps2dq((__v4sf)__a);
}
...
static __inline__ vec2di __DEFAULT_FN_ATTRS
sse2_cvttps_epi32(__m128 __a)
{
    return (vec2di)__builtin_ia32_cvttps2dq((__v4sf)__a);
}
...
static __inline__ vec2di __DEFAULT_FN_ATTRS
sse2_cvtsi32_si128(int __a)
{
    return __extension__ (vec2di)(__v4si){ __a, 0, 0, 0 };
}
...
static __inline__ vec2di __DEFAULT_FN_ATTRS
sse2_cvtsi64_si128(long long __a)
{
    return __extension__ (vec2di)(__v2di){ __a, 0 };
}
#endif
...
static __inline__ vec2di __DEFAULT_FN_ATTRS
sse2_load_si128(vec2di const *__p)
{
    return *__p;
}
...
/// \returns A 128-bit integer vector containing the moved values.
static __inline__ vec2di __DEFAULT_FN_ATTRS
sse2_loadu_si128(vec2di_u const *__p)
{
...
static __inline__ vec2di __DEFAULT_FN_ATTRS
sse2_loadl_epi64(vec2di_u const *__p)
{
    struct _sse2_loadl_epi64_struct {
        long long __u;
    } __attribute__((__packed__, __may_alias__));
    return __extension__ (vec2di) { ((struct _sse2_loadl_epi64_struct*)__p)->__u, 0};
}
...
static __inline__ vec2di __DEFAULT_FN_ATTRS
sse2_undefined_si128(void)
{
    return (vec2di)__builtin_ia32_undef128();
}
...
static __inline__ vec2di __DEFAULT_FN_ATTRS
sse2_set_epi64x(long long __q1, long long __q0)
{
    return __extension__ (vec2di)(__v2di){ __q0, __q1 };
}
...
///    provided in the operands.
static __inline__ vec2di __DEFAULT_FN_ATTRS
sse2_set_epi64(__m64 __q1, __m64 __q0)
{
    return sse2_set_epi64x((long long)__q1, (long long)__q0);
}
...
///    provided in the operands.
static __inline__ vec2di __DEFAULT_FN_ATTRS
sse2_set_epi32(int __i3, int __i2, int __i1, int __i0)
{
    return __extension__ (vec2di)(__v4si){ __i0, __i1, __i2, __i3};
}
...
///    provided in the operands.
static __inline__ vec2di __DEFAULT_FN_ATTRS
sse2_set_epi16(short __w7, short __w6, short __w5, short __w4, short __w3, short __w2, short __w1, short __w0)
{
    return __extension__ (vec2di)(__v8hi){ __w0, __w1, __w2, __w3, __w4, __w5, __w6, __w7 };
}
...
///    provided in the operands.
static __inline__ vec2di __DEFAULT_FN_ATTRS
sse2_set_epi8(char __b15, char __b14, char __b13, char __b12, char __b11, char __b10, char __b9, char __b8, char __b7, char __b6, char __b5, char __b4, char __b3, char __b2, char __b1, char __b0)
{
    return __extension__ (vec2di)(__v16qi){ __b0, __b1, __b2, __b3, __b4, __b5, __b6, __b7, __b8, __b9, __b10, __b11, __b12, __b13, __b14, __b15 };
}
...
static __inline__ vec2di __DEFAULT_FN_ATTRS
sse2_set1_epi64x(long long __q)
{
    return sse2_set_epi64x(__q, __q);
}
...
static __inline__ vec2di __DEFAULT_FN_ATTRS
sse2_set1_epi64(__m64 __q)
{
    return sse2_set_epi64(__q, __q);
}
...
///    containing the value provided in the operand.
static __inline__ vec2di __DEFAULT_FN_ATTRS
sse2_set1_epi32(int __i)
{
    return sse2_set_epi32(__i, __i, __i, __i);
}
...
///    containing the value provided in the operand.
static __inline__ vec2di __DEFAULT_FN_ATTRS
sse2_set1_epi16(short __w)
{
    return sse2_set_epi16(__w, __w, __w, __w, __w, __w, __w, __w);
}
...
///    containing the value provided in the operand.
static __inline__ vec2di __DEFAULT_FN_ATTRS
sse2_set1_epi8(char __b)
{
    return sse2_set_epi8(__b, __b, __b, __b, __b, __b, __b, __b, __b, __b, __b, __b, __b, __b, __b, __b);
}
...
static __inline__ vec2di __DEFAULT_FN_ATTRS
sse2_setr_epi64(__m64 __q0, __m64 __q1)
{
    return sse2_set_epi64(__q1, __q0);
}
...
/// \returns An initialized 128-bit integer vector.
static __inline__ vec2di __DEFAULT_FN_ATTRS
sse2_setr_epi32(int __i0, int __i1, int __i2, int __i3)
{
    return sse2_set_epi32(__i3, __i2, __i1, __i0);
}
...
/// \returns An initialized 128-bit integer vector.
static __inline__ vec2di __DEFAULT_FN_ATTRS
sse2_setr_epi16(short __w0, short __w1, short __w2, short __w3, short __w4, short __w5, short __w6, short __w7)
{
    return sse2_set_epi16(__w7, __w6, __w5, __w4, __w3, __w2, __w1, __w0);
}
...
/// \returns An initialized 128-bit integer vector.
static __inline__ vec2di __DEFAULT_FN_ATTRS
sse2_setr_epi8(char __b0, char __b1, char __b2, char __b3, char __b4, char __b5, char __b6, char __b7, char __b8, char __b9, char __b10, char __b11, char __b12, char __b13, char __b14, char __b15)
{
    return sse2_set_epi8(__b15, __b14, __b13, __b12, __b11, __b10, __b9, __b8, __b7, __b6, __b5, __b4, __b3, __b2, __b1, __b0);
}
...
///    zero.
static __inline__ vec2di __DEFAULT_FN_ATTRS
sse2_setzero_si128(void)
{
    return __extension__ (vec2di)(__v2di){ 0LL, 0LL };
}
...
static __inline__ void __DEFAULT_FN_ATTRS
sse2_store_si128(vec2di *__p, vec2di __b)
{
    *__p = __b;
}
...
///    A 128-bit integer vector containing the values to be moved.
static __inline__ void __DEFAULT_FN_ATTRS
sse2_storeu_si128(vec2di_u *__p, vec2di __b)
{
...
static __inline__ void __DEFAULT_FN_ATTRS
sse2_storeu_si64(void *__p, vec2di __b)
{
...
///    A 128-bit integer vector containing the value to be stored.
static __inline__ void __DEFAULT_FN_ATTRS
sse2_storeu_si32(void *__p, vec2di __b)
{
...
///    A 128-bit integer vector containing the value to be stored.
static __inline__ void __DEFAULT_FN_ATTRS
sse2_storeu_si16(void *__p, vec2di __b)
{
...
///    values are moved.
static __inline__ void __DEFAULT_FN_ATTRS
sse2_maskmoveu_si128(vec2di __d, vec2di __n, char *__p)
{
...
///    value to be stored.
static __inline__ void __DEFAULT_FN_ATTRS
sse2_storel_epi64(vec2di_u *__p, vec2di __a)
{
    struct _sse2_storel_epi64_struct {
        long long __u;
    } __attribute__((__packed__, __may_alias__));
    ((struct _sse2_storel_epi64_struct*)__p)->__u = __a[0];
}
...
static __inline__ void __DEFAULT_FN_ATTRS
sse2_stream_pd(double *__p, vec2df __a)
{
    __builtin_nontemporal_store((v2df)__a, (v2df*)__p);
}
...
static __inline__ void __DEFAULT_FN_ATTRS
sse2_stream_si128(vec2di *__p, vec2di __a)
{
...
sse2_stream_si32(int *__p, int __a)
{
...
static __inline__ void __attribute__((__always_inline__, __nodebug__, __target__("sse2")))
sse2_stream_si64(long long *__p, long long __a)
{
...
///    flushed.
void sse2_clflush(void const * __p);
...
static __inline__ vec2di __DEFAULT_FN_ATTRS
sse2_packs_epi16(vec2di __a, vec2di __b)
{
    return (vec2di)__builtin_ia32_packsswb128((__v8hi)__a, (__v8hi)__b);
}
...
static __inline__ vec2di __DEFAULT_FN_ATTRS
sse2_packs_epi32(vec2di __a, vec2di __b)
{
    return (vec2di)__builtin_ia32_packssdw128((__v4si)__a, (__v4si)__b);
}
...
/// \returns A 128-bit vector of [16 x i8] containing the converted values.
static __inline__ vec2di __DEFAULT_FN_ATTRS
sse2_packus_epi16(vec2di __a, vec2di __b)
{
    return (vec2di)__builtin_ia32_packuswb128((__v8hi)__a, (__v8hi)__b);
}
...
#define sse2_extract_epi16(a, imm) \
  (int)(unsigned short)__builtin_ia32_vec_ext_v8hi((__v8hi)(vec2di)(a), \
                                                   (int)(imm))
...
#define sse2_insert_epi16(a, b, imm) \
  (vec2di)__builtin_ia32_vec_set_v8hi((__v8hi)(vec2di)(a), (int)(b), \
                                       (int)(imm))
...
///
/// \code
/// vec2di sse2_shuffle_epi32(vec2di a, const int imm);
/// \endcode
///
...
#define sse2_shuffle_epi32(a, imm) \
  (vec2di)__builtin_ia32_pshufd((__v4si)(vec2di)(a), (int)(imm))
...
///
/// \code
/// vec2di sse2_shufflelo_epi16(vec2di a, const int imm);
/// \endcode
///
...
/// \returns A 128-bit integer vector containing the shuffled values.
#define sse2_shufflelo_epi16(a, imm) \
  (vec2di)__builtin_ia32_pshuflw((__v8hi)(vec2di)(a), (int)(imm))
...
///
/// \code
/// vec2di sse2_shufflehi_epi16(vec2di a, const int imm);
/// \endcode
///
...
/// \returns A 128-bit integer vector containing the shuffled values.
#define sse2_shufflehi_epi16(a, imm) \
  (vec2di)__builtin_ia32_pshufhw((__v8hi)(vec2di)(a), (int)(imm))
...
static __inline__ vec2di __DEFAULT_FN_ATTRS
sse2_unpackhi_epi8(vec2di __a, vec2di __b)
{
    return (vec2di)__builtin_shufflevector((__v16qi)__a, (__v16qi)__b, 8, 16+8, 9, 16+9, 10, 16+10, 11, 16+11, 12, 16+12, 13, 16+13, 14, 16+14, 15, 16+15);
}
...
static __inline__ vec2di __DEFAULT_FN_ATTRS
sse2_unpackhi_epi16(vec2di __a, vec2di __b)
{
    return (vec2di)__builtin_shufflevector((__v8hi)__a, (__v8hi)__b, 4, 8+4, 5, 8+5, 6, 8+6, 7, 8+7);
}
...
static __inline__ vec2di __DEFAULT_FN_ATTRS
sse2_unpackhi_epi32(vec2di __a, vec2di __b)
{
    return (vec2di)__builtin_shufflevector((__v4si)__a, (__v4si)__b, 2, 4+2, 3, 4+3);
}
...
static __inline__ vec2di __DEFAULT_FN_ATTRS
sse2_unpackhi_epi64(vec2di __a, vec2di __b)
{
    return (vec2di)__builtin_shufflevector((__v2di)__a, (__v2di)__b, 1, 2+1);
}
...
/// \returns A 128-bit vector of [16 x i8] containing the interleaved values.
static __inline__ vec2di __DEFAULT_FN_ATTRS
sse2_unpacklo_epi8(vec2di __a, vec2di __b)
{
    return (vec2di)__builtin_shufflevector((__v16qi)__a, (__v16qi)__b, 0, 16+0, 1, 16+1, 2, 16+2, 3, 16+3, 4, 16+4, 5, 16+5, 6, 16+6, 7, 16+7);
}
...
/// \returns A 128-bit vector of [8 x i16] containing the interleaved values.
static __inline__ vec2di __DEFAULT_FN_ATTRS
sse2_unpacklo_epi16(vec2di __a, vec2di __b)
{
    return (vec2di)__builtin_shufflevector((__v8hi)__a, (__v8hi)__b, 0, 8+0, 1, 8+1, 2, 8+2, 3, 8+3);
}
...
/// \returns A 128-bit vector of [4 x i32] containing the interleaved values.
static __inline__ vec2di __DEFAULT_FN_ATTRS
sse2_unpacklo_epi32(vec2di __a, vec2di __b)
{
    return (vec2di)__builtin_shufflevector((__v4si)__a, (__v4si)__b, 0, 4+0, 1, 4+1);
}
...
/// \returns A 128-bit vector of [2 x i64] containing the interleaved values.
static __inline__ vec2di __DEFAULT_FN_ATTRS
sse2_unpacklo_epi64(vec2di __a, vec2di __b)
{
    return (vec2di)__builtin_shufflevector((__v2di)__a, (__v2di)__b, 0, 2+0);
}
...
static __inline__ vec2di __DEFAULT_FN_ATTRS
sse2_movpi64_epi64(__m64 __a)
{
    return __extension__ (vec2di)(__v2di){ (long long)__a, 0 };
}
...
///    the operand. The upper 64 bits are assigned zeros.
static __inline__ vec2di __DEFAULT_FN_ATTRS
sse2_move_epi64(vec2di __a)
{
    return __builtin_shufflevector((v2di)__a, sse2_setzero_si128(), 0, 2);
}
...
static __inline__ vec2df __DEFAULT_FN_ATTRS
sse2_unpackhi_pd(vec2df __a, vec2df __b)
{
    return __builtin_shufflevector((v2df)__a, (v2df)__b, 1, 2+1);
}
...
/// \returns A 128-bit vector of [2 x double] containing the interleaved values.
static __inline__ vec2df __DEFAULT_FN_ATTRS
sse2_unpacklo_pd(vec2df __a, vec2df __b)
{
    return __builtin_shufflevector((v2df)__a, (v2df)__b, 0, 2+0);
}
...
static __inline__ int __DEFAULT_FN_ATTRS
sse2_movemask_pd(vec2df __a)
{
    return __builtin_ia32_movmskpd((v2df)__a);
}
...
///
/// \code
/// vec2df sse2_shuffle_pd(vec2df a, vec2df b, const int i);
/// \endcode
///
...
#define sse2_shuffle_pd(a, b, i) \
  (vec2df)__builtin_ia32_shufpd((v2df)(vec2df)(a), (v2df)(vec2df)(b), \
                                 (int)(i))
...
#define _MM_GET_DENORMALS_ZERO_MODE() (sse2_getcsr() & _MM_DENORMALS_ZERO_MASK)
#define _MM_SET_DENORMALS_ZERO_MODE(x) (sse2_setcsr((sse2_getcsr() & ~_MM_DENORMALS_ZERO_MASK) | (x)))
